...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	32858593          	addi	a1,a1,808 # 1338 <malloc+0xfa>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2ea58593          	addi	a1,a1,746 # 1348 <malloc+0x10a>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2b850513          	addi	a0,a0,696 # 1350 <malloc+0x112>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	38c70713          	addi	a4,a4,908 # 1450 <malloc+0x212>
    ...
    panic("runcmd");
      ...
      e4:	27850513          	addi	a0,a0,632 # 1358 <malloc+0x11a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	25e58593          	addi	a1,a1,606 # 1360 <malloc+0x122>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	048080e7          	jalr	72(ra) # 1154 <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	22258593          	addi	a1,a1,546 # 1370 <malloc+0x132>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	ffc080e7          	jalr	-4(ra) # 1154 <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1e8:	19c50513          	addi	a0,a0,412 # 1380 <malloc+0x142>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	8e498993          	addi	s3,s3,-1820 # 1ce0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	87e98993          	addi	s3,s3,-1922 # 1ce0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	81298993          	addi	s3,s3,-2030 # 1ce0 <whitespace>
     4d6:	00002a97          	auipc	s5,0x2
     4da:	802a8a93          	addi	s5,s5,-2046 # 1cd8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	79c98993          	addi	s3,s3,1948 # 1ce0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	df2b0b13          	addi	s6,s6,-526 # 13a8 <malloc+0x16a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5d0:	dbc50513          	addi	a0,a0,-580 # 1388 <malloc+0x14a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6ac:	d0860613          	addi	a2,a2,-760 # 13b0 <malloc+0x172>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6ec:	ce8b0b13          	addi	s6,s6,-792 # 13d0 <malloc+0x192>
  ...
  return ret;
     ...
     722:	c9a50513          	addi	a0,a0,-870 # 13b8 <malloc+0x17a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c4450513          	addi	a0,a0,-956 # 13c0 <malloc+0x182>
...
00000000000007aa <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ca:	c1260613          	addi	a2,a2,-1006 # 13d8 <malloc+0x19a>
     7ce:	85ce                	mv	a1,s3
     7d0:	854a                	mv	a0,s2
...
0000000000000818 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     83a:	baaa0a13          	addi	s4,s4,-1110 # 13e0 <malloc+0x1a2>
  ...
  if(peek(ps, es, ";")){
     ...
     870:	b7c60613          	addi	a2,a2,-1156 # 13e8 <malloc+0x1aa>
     874:	85ce                	mv	a1,s3
     876:	854a                	mv	a0,s2
...
00000000000008c0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8d6:	ade60613          	addi	a2,a2,-1314 # 13b0 <malloc+0x172>
  ...
  if(!peek(ps, es, ")"))
     ...
     906:	afe60613          	addi	a2,a2,-1282 # 1400 <malloc+0x1c2>
     90a:	85ca                	mv	a1,s2
     90c:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     948:	aac50513          	addi	a0,a0,-1364 # 13f0 <malloc+0x1b2>
     94c:	fffff097          	auipc	ra,0xfffff
     950:	708080e7          	jalr	1800(ra) # 54 <panic>
    panic("syntax - missing )");
     954:	00001517          	auipc	a0,0x1
     958:	ab450513          	addi	a0,a0,-1356 # 1408 <malloc+0x1ca>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     984:	ae870713          	addi	a4,a4,-1304 # 1468 <malloc+0x22a>
...
00000000000009fc <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a34:	91060613          	addi	a2,a2,-1776 # 1340 <malloc+0x102>
     a38:	85a6                	mv	a1,s1
     a3a:	854e                	mv	a0,s3
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a6a:	9ba58593          	addi	a1,a1,-1606 # 1420 <malloc+0x1e2>
     a6e:	4509                	li	a0,2
     a70:	00000097          	auipc	ra,0x0
     a74:	6e4080e7          	jalr	1764(ra) # 1154 <fprintf>
    panic("syntax");
     a78:	00001517          	auipc	a0,0x1
     a7c:	94050513          	addi	a0,a0,-1728 # 13b8 <malloc+0x17a>
...
0000000000000a88 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     aa0:	99490913          	addi	s2,s2,-1644 # 1430 <malloc+0x1f2>
     aa4:	85a6                	mv	a1,s1
     aa6:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     ac4:	23048493          	addi	s1,s1,560 # 1cf0 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b16:	1dea8a93          	addi	s5,s5,478 # 1cf0 <buf.0>
     b1a:	8556                	mv	a0,s5
     ...
     b36:	1c150513          	addi	a0,a0,449 # 1cf3 <buf.0+0x3>
     b3a:	00000097          	auipc	ra,0x0
     b3e:	35a080e7          	jalr	858(ra) # e94 <chdir>
     b42:	fa0554e3          	bgez	a0,aea <main+0x62>
        fprintf(2, "cannot cd %s\n", buf+3);
     b46:	00001617          	auipc	a2,0x1
     b4a:	1ad60613          	addi	a2,a2,429 # 1cf3 <buf.0+0x3>
     b4e:	00001597          	auipc	a1,0x1
     b52:	8ea58593          	addi	a1,a1,-1814 # 1438 <malloc+0x1fa>
     b56:	4509                	li	a0,2
     b58:	00000097          	auipc	ra,0x0
     b5c:	5fc080e7          	jalr	1532(ra) # 1154 <fprintf>
     b60:	b769                	j	aea <main+0x62>
      runcmd(parsecmd(buf));
     b62:	00001517          	auipc	a0,0x1
     b66:	18e50513          	addi	a0,a0,398 # 1cf0 <buf.0>
...
putc(int fd, char c)
{
     ecc:	1101                	addi	sp,sp,-32
     ece:	ec06                	sd	ra,24(sp)
     ed0:	e822                	sd	s0,16(sp)
     ed2:	1000                	addi	s0,sp,32
     ed4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     ed8:	4605                	li	a2,1
     eda:	fef40593          	addi	a1,s0,-17
     ede:	00000097          	auipc	ra,0x0
     ee2:	f66080e7          	jalr	-154(ra) # e44 <write>
}
     ee6:	60e2                	ld	ra,24(sp)
     ee8:	6442                	ld	s0,16(sp)
     eea:	6105                	addi	sp,sp,32
     eec:	8082                	ret

0000000000000eee <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
     eee:	7139                	addi	sp,sp,-64
     ef0:	fc06                	sd	ra,56(sp)
     ef2:	f822                	sd	s0,48(sp)
     ef4:	f426                	sd	s1,40(sp)
     ef6:	f04a                	sd	s2,32(sp)
     ef8:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     efe:	c299                	beqz	a3,f04 <printint+0x16>
     f00:	0805c063          	bltz	a1,f80 <printint+0x92>
  neg = 0;
     f04:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
     f0e:	00000817          	auipc	a6,0x0
     f12:	5ca80813          	addi	a6,a6,1482 # 14d8 <digits>
     f16:	88be                	mv	a7,a5
     f18:	0017851b          	addiw	a0,a5,1
     f1c:	87aa                	mv	a5,a0
     f1e:	02c5f73b          	remuw	a4,a1,a2
     f22:	1702                	slli	a4,a4,0x20
     f24:	9301                	srli	a4,a4,0x20
     f26:	9742                	add	a4,a4,a6
     f28:	00074703          	lbu	a4,0(a4)
     f2c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     f30:	872e                	mv	a4,a1
     f32:	02c5d5bb          	divuw	a1,a1,a2
     f36:	0685                	addi	a3,a3,1
     f38:	fcc77fe3          	bgeu	a4,a2,f16 <printint+0x28>
  if(neg)
     f3c:	000e0c63          	beqz	t3,f54 <printint+0x66>
    buf[i++] = '-';
     f40:	fd050793          	addi	a5,a0,-48
     f44:	00878533          	add	a0,a5,s0
     f48:	02d00793          	li	a5,45
     f4c:	fef50823          	sb	a5,-16(a0)
     f50:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
     f54:	fff7899b          	addiw	s3,a5,-1
     f58:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
     f5c:	fff4c583          	lbu	a1,-1(s1)
     f60:	854a                	mv	a0,s2
     f62:	00000097          	auipc	ra,0x0
     f66:	f6a080e7          	jalr	-150(ra) # ecc <putc>
  while(--i >= 0)
     f6a:	39fd                	addiw	s3,s3,-1
     f6c:	14fd                	addi	s1,s1,-1
     f6e:	fe09d7e3          	bgez	s3,f5c <printint+0x6e>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fc0:	f10080e7          	jalr	-240(ra) # ecc <putc>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1004:	48070713          	addi	a4,a4,1152 # 1480 <malloc+0x242>
    ...
    1022:	ed0080e7          	jalr	-304(ra) # eee <printint>
    1026:	8bca                	mv	s7,s2
      } else {
    ...
    103e:	eb4080e7          	jalr	-332(ra) # eee <printint>
    1042:	8bca                	mv	s7,s2
      state = 0;
    1044:	4981                	li	s3,0
    ...
    105a:	e98080e7          	jalr	-360(ra) # eee <printint>
    105e:	8bca                	mv	s7,s2
      state = 0;
    1060:	4981                	li	s3,0
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d0:	e00080e7          	jalr	-512(ra) # ecc <putc>
          s++;
    ...
    10e6:	36690913          	addi	s2,s2,870 # 1448 <malloc+0x20a>
        while(*s != 0){
    ...
    10fe:	dd2080e7          	jalr	-558(ra) # ecc <putc>
    1102:	8bca                	mv	s7,s2
      state = 0;
    1104:	4981                	li	s3,0
    ...
    1112:	dbe080e7          	jalr	-578(ra) # ecc <putc>
      state = 0;
    1116:	4981                	li	s3,0
    ...
    1124:	dac080e7          	jalr	-596(ra) # ecc <putc>
        putc(fd, c);
    1128:	85ca                	mv	a1,s2
    112a:	8556                	mv	a0,s5
    112c:	00000097          	auipc	ra,0x0
    1130:	da0080e7          	jalr	-608(ra) # ecc <putc>
      state = 0;
    1134:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11c8:	b247b783          	ld	a5,-1244(a5) # 1ce8 <freep>
    11cc:	a02d                	j	11f6 <free+0x3e>
  ...
  if(p + p->s.size == bp){
    ...
    11e8:	a091                	j	122c <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11ea:	6398                	ld	a4,0(a5)
    11ec:	00e7e463          	bltu	a5,a4,11f4 <free+0x3c>
    11f0:	00e6ea63          	bltu	a3,a4,1204 <free+0x4c>
{
    11f4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f6:	fed7fae3          	bgeu	a5,a3,11ea <free+0x32>
    11fa:	6398                	ld	a4,0(a5)
    11fc:	00e6e463          	bltu	a3,a4,1204 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1200:	fee7eae3          	bltu	a5,a4,11f4 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    ...
    1214:	fae60de3          	beq	a2,a4,11ce <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    1228:	fae68ae3          	beq	a3,a4,11dc <free+0x24>
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    1232:	aaf73d23          	sd	a5,-1350(a4) # 1ce8 <freep>
}
    1236:	60a2                	ld	ra,8(sp)
    1238:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    124a:	02051993          	slli	s3,a0,0x20
    124e:	0209d993          	srli	s3,s3,0x20
    1252:	09bd                	addi	s3,s3,15
    1254:	0049d993          	srli	s3,s3,0x4
    1258:	2985                	addiw	s3,s3,1
    125a:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    125c:	00001517          	auipc	a0,0x1
    1260:	a8c53503          	ld	a0,-1396(a0) # 1ce8 <freep>
    1264:	c905                	beqz	a0,1294 <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    126a:	09377a63          	bgeu	a4,s3,12fe <malloc+0xc0>
  ...
  if(nu < 4096)
    1276:	8a4e                	mv	s4,s3
    1278:	6705                	lui	a4,0x1
    127a:	00e9f363          	bgeu	s3,a4,1280 <malloc+0x42>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    128c:	a6048493          	addi	s1,s1,-1440 # 1ce8 <freep>
  if(p == (char*)-1)
    1290:	5afd                	li	s5,-1
    1292:	a089                	j	12d4 <malloc+0x96>
    ...
    12a0:	abc78793          	addi	a5,a5,-1348 # 1d58 <base>
    12a4:	00001717          	auipc	a4,0x1
    12a8:	a4f73223          	sd	a5,-1468(a4) # 1ce8 <freep>
    12ac:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12ae:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12b2:	b7d1                	j	1276 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    12b4:	6398                	ld	a4,0(a5)
    12b6:	e118                	sd	a4,0(a0)
    12b8:	a8b9                	j	1316 <malloc+0xd8>
  hp->s.size = nu;
    12ba:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12be:	0541                	addi	a0,a0,16
    12c0:	00000097          	auipc	ra,0x0
    12c4:	ef8080e7          	jalr	-264(ra) # 11b8 <free>
  return freep;
    12c8:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    12ca:	c135                	beqz	a0,132e <malloc+0xf0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12cc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12ce:	4798                	lw	a4,8(a5)
    12d0:	03277363          	bgeu	a4,s2,12f6 <malloc+0xb8>
    if(p == freep)
    12d4:	6098                	ld	a4,0(s1)
    12d6:	853e                	mv	a0,a5
    12d8:	fef71ae3          	bne	a4,a5,12cc <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    12dc:	8552                	mv	a0,s4
    12de:	00000097          	auipc	ra,0x0
    12e2:	bce080e7          	jalr	-1074(ra) # eac <sbrk>
  if(p == (char*)-1)
    12e6:	fd551ae3          	bne	a0,s5,12ba <malloc+0x7c>
        return 0;
    12ea:	4501                	li	a0,0
    12ec:	74a2                	ld	s1,40(sp)
    12ee:	6a42                	ld	s4,16(sp)
    12f0:	6aa2                	ld	s5,8(sp)
    12f2:	6b02                	ld	s6,0(sp)
    12f4:	a03d                	j	1322 <malloc+0xe4>
    12f6:	74a2                	ld	s1,40(sp)
    12f8:	6a42                	ld	s4,16(sp)
    12fa:	6aa2                	ld	s5,8(sp)
    12fc:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    12fe:	fae90be3          	beq	s2,a4,12b4 <malloc+0x76>
        p->s.size -= nunits;
    ...
    131a:	9ca73923          	sd	a0,-1582(a4) # 1ce8 <freep>
      return (void*)(p + 1);
