...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	ffa50513          	addi	a0,a0,-6 # 6038 <malloc+0xfa>
      46:	00006097          	auipc	ra,0x6
      4a:	e3c080e7          	jalr	-452(ra) # 5e82 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	d0878793          	addi	a5,a5,-760 # ad60 <uninit>
      60:	0000d697          	auipc	a3,0xd
      64:	41068693          	addi	a3,a3,1040 # d470 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	fd850513          	addi	a0,a0,-40 # 6058 <malloc+0x11a>
      88:	00006097          	auipc	ra,0x6
      8c:	dfa080e7          	jalr	-518(ra) # 5e82 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	fc850513          	addi	a0,a0,-56 # 6070 <malloc+0x132>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	fca50513          	addi	a0,a0,-54 # 6090 <malloc+0x152>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	f9250513          	addi	a0,a0,-110 # 6078 <malloc+0x13a>
      ee:	00006097          	auipc	ra,0x6
      f2:	d94080e7          	jalr	-620(ra) # 5e82 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	f9e50513          	addi	a0,a0,-98 # 60a0 <malloc+0x162>
     10a:	00006097          	auipc	ra,0x6
     10e:	d78080e7          	jalr	-648(ra) # 5e82 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	f9c50513          	addi	a0,a0,-100 # 60c8 <malloc+0x18a>
     134:	00006097          	auipc	ra,0x6
     138:	a40080e7          	jalr	-1472(ra) # 5b74 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	f8850513          	addi	a0,a0,-120 # 60c8 <malloc+0x18a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	f8458593          	addi	a1,a1,-124 # 60d8 <malloc+0x19a>
     15c:	00006097          	auipc	ra,0x6
     160:	9e8080e7          	jalr	-1560(ra) # 5b44 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	f6050513          	addi	a0,a0,-160 # 60c8 <malloc+0x18a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	f6458593          	addi	a1,a1,-156 # 60e0 <malloc+0x1a2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	f3450513          	addi	a0,a0,-204 # 60c8 <malloc+0x18a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	f1e50513          	addi	a0,a0,-226 # 60e8 <malloc+0x1aa>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	cb0080e7          	jalr	-848(ra) # 5e82 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000272 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     290:	e8450513          	addi	a0,a0,-380 # 6110 <malloc+0x1d2>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	e6ca8a93          	addi	s5,s5,-404 # 6110 <malloc+0x1d2>
      int cc = write(fd, buf, sz);
     2ac:	0000da17          	auipc	s4,0xd
     2b0:	1c4a0a13          	addi	s4,s4,452 # d470 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	dfa50513          	addi	a0,a0,-518 # 6120 <malloc+0x1e2>
     32e:	00006097          	auipc	ra,0x6
     332:	b54080e7          	jalr	-1196(ra) # 5e82 <printf>
      exit(1);
     336:	4505                	li	a0,1
     ...
     34c:	df850513          	addi	a0,a0,-520 # 6140 <malloc+0x202>
     350:	00006097          	auipc	ra,0x6
     354:	b32080e7          	jalr	-1230(ra) # 5e82 <printf>
        exit(1);
     358:	4505                	li	a0,1
...
0000000000000362 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     394:	dc8a8a93          	addi	s5,s5,-568 # 6158 <malloc+0x21a>
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     44c:	d1850513          	addi	a0,a0,-744 # 6160 <malloc+0x222>
     450:	00006097          	auipc	ra,0x6
     454:	a32080e7          	jalr	-1486(ra) # 5e82 <printf>
      exit(1);
     458:	4505                	li	a0,1
     ...
     46a:	d1250513          	addi	a0,a0,-750 # 6178 <malloc+0x23a>
     46e:	00006097          	auipc	ra,0x6
     472:	a14080e7          	jalr	-1516(ra) # 5e82 <printf>
      exit(1);
     476:	4505                	li	a0,1
     ...
     488:	d2450513          	addi	a0,a0,-732 # 61a8 <malloc+0x26a>
     48c:	00006097          	auipc	ra,0x6
     490:	9f6080e7          	jalr	-1546(ra) # 5e82 <printf>
      exit(1);
     494:	4505                	li	a0,1
     ...
     4a2:	d3a50513          	addi	a0,a0,-710 # 61d8 <malloc+0x29a>
     4a6:	00006097          	auipc	ra,0x6
     4aa:	9dc080e7          	jalr	-1572(ra) # 5e82 <printf>
      exit(1);
     4ae:	4505                	li	a0,1
     ...
     4c0:	d2c50513          	addi	a0,a0,-724 # 61e8 <malloc+0x2aa>
     4c4:	00006097          	auipc	ra,0x6
     4c8:	9be080e7          	jalr	-1602(ra) # 5e82 <printf>
      exit(1);
     4cc:	4505                	li	a0,1
...
00000000000004d6 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     504:	d18b8b93          	addi	s7,s7,-744 # 6218 <malloc+0x2da>
    ...
    n = write(fds[1], "x", 1);
     ...
     514:	bd0c0c13          	addi	s8,s8,-1072 # 60e0 <malloc+0x1a2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     5bc:	c6850513          	addi	a0,a0,-920 # 6220 <malloc+0x2e2>
     5c0:	00006097          	auipc	ra,0x6
     5c4:	8c2080e7          	jalr	-1854(ra) # 5e82 <printf>
      exit(1);
     5c8:	4505                	li	a0,1
     ...
     5da:	c6250513          	addi	a0,a0,-926 # 6238 <malloc+0x2fa>
     5de:	00006097          	auipc	ra,0x6
     5e2:	8a4080e7          	jalr	-1884(ra) # 5e82 <printf>
      exit(1);
     5e6:	4505                	li	a0,1
     ...
     5f4:	be850513          	addi	a0,a0,-1048 # 61d8 <malloc+0x29a>
     5f8:	00006097          	auipc	ra,0x6
     5fc:	88a080e7          	jalr	-1910(ra) # 5e82 <printf>
      exit(1);
     600:	4505                	li	a0,1
     ...
     60e:	c5e50513          	addi	a0,a0,-930 # 6268 <malloc+0x32a>
     612:	00006097          	auipc	ra,0x6
     616:	870080e7          	jalr	-1936(ra) # 5e82 <printf>
      exit(1);
     61a:	4505                	li	a0,1
     ...
     62c:	c5850513          	addi	a0,a0,-936 # 6280 <malloc+0x342>
     630:	00006097          	auipc	ra,0x6
     634:	852080e7          	jalr	-1966(ra) # 5e82 <printf>
      exit(1);
     638:	4505                	li	a0,1
...
0000000000000642 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     682:	a5a58593          	addi	a1,a1,-1446 # 60d8 <malloc+0x19a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     69e:	a2e50513          	addi	a0,a0,-1490 # 60c8 <malloc+0x18a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6ca:	a0250513          	addi	a0,a0,-1534 # 60c8 <malloc+0x18a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6de:	9ee50513          	addi	a0,a0,-1554 # 60c8 <malloc+0x18a>
  ...
  write(fd1, "abcdef", 6);
     ...
     71c:	bf858593          	addi	a1,a1,-1032 # 6310 <malloc+0x3d2>
     720:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     75e:	96e50513          	addi	a0,a0,-1682 # 60c8 <malloc+0x18a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7a2:	b1250513          	addi	a0,a0,-1262 # 62b0 <malloc+0x372>
     7a6:	00005097          	auipc	ra,0x5
     7aa:	6dc080e7          	jalr	1756(ra) # 5e82 <printf>
    exit(1);
     7ae:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     7be:	b1650513          	addi	a0,a0,-1258 # 62d0 <malloc+0x392>
     7c2:	00005097          	auipc	ra,0x5
     7c6:	6c0080e7          	jalr	1728(ra) # 5e82 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7ca:	8652                	mv	a2,s4
     7cc:	85d6                	mv	a1,s5
     7ce:	00006517          	auipc	a0,0x6
     7d2:	b1250513          	addi	a0,a0,-1262 # 62e0 <malloc+0x3a2>
     7d6:	00005097          	auipc	ra,0x5
     7da:	6ac080e7          	jalr	1708(ra) # 5e82 <printf>
    exit(1);
     7de:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7ee:	b1650513          	addi	a0,a0,-1258 # 6300 <malloc+0x3c2>
     7f2:	00005097          	auipc	ra,0x5
     7f6:	690080e7          	jalr	1680(ra) # 5e82 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7fa:	8652                	mv	a2,s4
     7fc:	85d6                	mv	a1,s5
     7fe:	00006517          	auipc	a0,0x6
     802:	ae250513          	addi	a0,a0,-1310 # 62e0 <malloc+0x3a2>
     806:	00005097          	auipc	ra,0x5
     80a:	67c080e7          	jalr	1660(ra) # 5e82 <printf>
    exit(1);
     80e:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     820:	afc50513          	addi	a0,a0,-1284 # 6318 <malloc+0x3da>
     824:	00005097          	auipc	ra,0x5
     828:	65e080e7          	jalr	1630(ra) # 5e82 <printf>
    exit(1);
     82c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     83e:	afe50513          	addi	a0,a0,-1282 # 6338 <malloc+0x3fa>
     842:	00005097          	auipc	ra,0x5
     846:	640080e7          	jalr	1600(ra) # 5e82 <printf>
    exit(1);
     84a:	4505                	li	a0,1
...
0000000000000854 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     874:	ae850513          	addi	a0,a0,-1304 # 6358 <malloc+0x41a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     88e:	af6a0a13          	addi	s4,s4,-1290 # 6380 <malloc+0x442>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     892:	00006b17          	auipc	s6,0x6
     896:	b26b0b13          	addi	s6,s6,-1242 # 63b8 <malloc+0x47a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8d8:	a8450513          	addi	a0,a0,-1404 # 6358 <malloc+0x41a>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8ee:	0000d597          	auipc	a1,0xd
     8f2:	b8258593          	addi	a1,a1,-1150 # d470 <buf>
  ...
  if(unlink("small") < 0){
     ...
     914:	a4850513          	addi	a0,a0,-1464 # 6358 <malloc+0x41a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     940:	a2450513          	addi	a0,a0,-1500 # 6360 <malloc+0x422>
     944:	00005097          	auipc	ra,0x5
     948:	53e080e7          	jalr	1342(ra) # 5e82 <printf>
    exit(1);
     94c:	4505                	li	a0,1
     ...
     95e:	a3650513          	addi	a0,a0,-1482 # 6390 <malloc+0x452>
     962:	00005097          	auipc	ra,0x5
     966:	520080e7          	jalr	1312(ra) # 5e82 <printf>
      exit(1);
     96a:	4505                	li	a0,1
     ...
     97c:	a5050513          	addi	a0,a0,-1456 # 63c8 <malloc+0x48a>
     980:	00005097          	auipc	ra,0x5
     984:	502080e7          	jalr	1282(ra) # 5e82 <printf>
      exit(1);
     988:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     998:	a5c50513          	addi	a0,a0,-1444 # 63f0 <malloc+0x4b2>
     99c:	00005097          	auipc	ra,0x5
     9a0:	4e6080e7          	jalr	1254(ra) # 5e82 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9b4:	a6050513          	addi	a0,a0,-1440 # 6410 <malloc+0x4d2>
     9b8:	00005097          	auipc	ra,0x5
     9bc:	4ca080e7          	jalr	1226(ra) # 5e82 <printf>
    exit(1);
     9c0:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9d0:	a5c50513          	addi	a0,a0,-1444 # 6428 <malloc+0x4ea>
     9d4:	00005097          	auipc	ra,0x5
     9d8:	4ae080e7          	jalr	1198(ra) # 5e82 <printf>
    exit(1);
     9dc:	4505                	li	a0,1
...
00000000000009e6 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a04:	a4850513          	addi	a0,a0,-1464 # 6448 <malloc+0x50a>
  ...
  if(fd < 0){
     ...
     a16:	4481                	li	s1,0
    ((int*)buf)[0] = i;
     a18:	0000d997          	auipc	s3,0xd
     a1c:	a5898993          	addi	s3,s3,-1448 # d470 <buf>
  ...
  fd = open("big", O_RDONLY);
     ...
     a54:	9f850513          	addi	a0,a0,-1544 # 6448 <malloc+0x50a>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a68:	0000d917          	auipc	s2,0xd
     a6c:	a0890913          	addi	s2,s2,-1528 # d470 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a9a:	9ba50513          	addi	a0,a0,-1606 # 6450 <malloc+0x512>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	3e4080e7          	jalr	996(ra) # 5e82 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
     ...
     ab8:	9bc50513          	addi	a0,a0,-1604 # 6470 <malloc+0x532>
     abc:	00005097          	auipc	ra,0x5
     ac0:	3c6080e7          	jalr	966(ra) # 5e82 <printf>
      exit(1);
     ac4:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ad4:	9c850513          	addi	a0,a0,-1592 # 6498 <malloc+0x55a>
     ad8:	00005097          	auipc	ra,0x5
     adc:	3aa080e7          	jalr	938(ra) # 5e82 <printf>
    exit(1);
     ae0:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     b00:	94c50513          	addi	a0,a0,-1716 # 6448 <malloc+0x50a>
     ...
     b2c:	99050513          	addi	a0,a0,-1648 # 64b8 <malloc+0x57a>
     b30:	00005097          	auipc	ra,0x5
     b34:	352080e7          	jalr	850(ra) # 5e82 <printf>
        exit(1);
     b38:	4505                	li	a0,1
     ...
     b4a:	99a50513          	addi	a0,a0,-1638 # 64e0 <malloc+0x5a2>
     b4e:	00005097          	auipc	ra,0x5
     b52:	334080e7          	jalr	820(ra) # 5e82 <printf>
      exit(1);
     b56:	4505                	li	a0,1
     ...
     b68:	99450513          	addi	a0,a0,-1644 # 64f8 <malloc+0x5ba>
     b6c:	00005097          	auipc	ra,0x5
     b70:	316080e7          	jalr	790(ra) # 5e82 <printf>
      exit(1);
     b74:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b84:	9a050513          	addi	a0,a0,-1632 # 6520 <malloc+0x5e2>
     b88:	00005097          	auipc	ra,0x5
     b8c:	2fa080e7          	jalr	762(ra) # 5e82 <printf>
    exit(1);
     b90:	4505                	li	a0,1
...
0000000000000b9a <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bb2:	98a50513          	addi	a0,a0,-1654 # 6538 <malloc+0x5fa>
  ...
  write(fd, "hello", SZ);
     ...
     bca:	9a258593          	addi	a1,a1,-1630 # 6568 <malloc+0x62a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     be6:	95650513          	addi	a0,a0,-1706 # 6538 <malloc+0x5fa>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bfc:	94050513          	addi	a0,a0,-1728 # 6538 <malloc+0x5fa>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     c12:	92a50513          	addi	a0,a0,-1750 # 6538 <malloc+0x5fa>
  ...
  write(fd1, "yyy", 3);
     ...
     c26:	98e58593          	addi	a1,a1,-1650 # 65b0 <malloc+0x672>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     c3c:	660d                	lui	a2,0x3
     c3e:	0000d597          	auipc	a1,0xd
     c42:	83258593          	addi	a1,a1,-1998 # d470 <buf>
     c46:	8526                	mv	a0,s1
  ...
  if(buf[0] != 'h'){
     c56:	0000d717          	auipc	a4,0xd
     c5a:	81a74703          	lbu	a4,-2022(a4) # d470 <buf>
     c5e:	06800793          	li	a5,104
     c62:	0af71b63          	bne	a4,a5,d18 <unlinkread+0x17e>
  if(write(fd, buf, 10) != 10){
     c66:	4629                	li	a2,10
     c68:	0000d597          	auipc	a1,0xd
     c6c:	80858593          	addi	a1,a1,-2040 # d470 <buf>
     c70:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c8e:	8ae50513          	addi	a0,a0,-1874 # 6538 <malloc+0x5fa>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     cae:	89e50513          	addi	a0,a0,-1890 # 6548 <malloc+0x60a>
     cb2:	00005097          	auipc	ra,0x5
     cb6:	1d0080e7          	jalr	464(ra) # 5e82 <printf>
    exit(1);
     cba:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     cca:	8aa50513          	addi	a0,a0,-1878 # 6570 <malloc+0x632>
     cce:	00005097          	auipc	ra,0x5
     cd2:	1b4080e7          	jalr	436(ra) # 5e82 <printf>
    exit(1);
     cd6:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     ce6:	8ae50513          	addi	a0,a0,-1874 # 6590 <malloc+0x652>
     cea:	00005097          	auipc	ra,0x5
     cee:	198080e7          	jalr	408(ra) # 5e82 <printf>
    exit(1);
     cf2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     d02:	8ba50513          	addi	a0,a0,-1862 # 65b8 <malloc+0x67a>
     d06:	00005097          	auipc	ra,0x5
     d0a:	17c080e7          	jalr	380(ra) # 5e82 <printf>
    exit(1);
     d0e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     d1e:	8be50513          	addi	a0,a0,-1858 # 65d8 <malloc+0x69a>
     d22:	00005097          	auipc	ra,0x5
     d26:	160080e7          	jalr	352(ra) # 5e82 <printf>
    exit(1);
     d2a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d3a:	8c250513          	addi	a0,a0,-1854 # 65f8 <malloc+0x6ba>
     d3e:	00005097          	auipc	ra,0x5
     d42:	144080e7          	jalr	324(ra) # 5e82 <printf>
    exit(1);
     d46:	4505                	li	a0,1
...
0000000000000d50 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d9e:	7ce58593          	addi	a1,a1,1998 # 6568 <malloc+0x62a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     dbe:	86658593          	addi	a1,a1,-1946 # 6620 <malloc+0x6e2>
     dc2:	00006517          	auipc	a0,0x6
     dc6:	85650513          	addi	a0,a0,-1962 # 6618 <malloc+0x6da>
  ...
  unlink("lf1");
     ...
     dda:	84250513          	addi	a0,a0,-1982 # 6618 <malloc+0x6da>
     dde:	00005097          	auipc	ra,0x5
     de2:	d96080e7          	jalr	-618(ra) # 5b74 <unlink>
  if(open("lf1", 0) >= 0){
     de6:	4581                	li	a1,0
     de8:	00006517          	auipc	a0,0x6
     dec:	83050513          	addi	a0,a0,-2000 # 6618 <malloc+0x6da>
  ...
  fd = open("lf2", 0);
     ...
     e02:	82250513          	addi	a0,a0,-2014 # 6620 <malloc+0x6e2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     e1a:	65a58593          	addi	a1,a1,1626 # d470 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e3a:	7ea58593          	addi	a1,a1,2026 # 6620 <malloc+0x6e2>
     e3e:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e50:	7d450513          	addi	a0,a0,2004 # 6620 <malloc+0x6e2>
     e54:	00005097          	auipc	ra,0x5
     e58:	d20080e7          	jalr	-736(ra) # 5b74 <unlink>
  if(link("lf2", "lf1") >= 0){
     e5c:	00005597          	auipc	a1,0x5
     e60:	7bc58593          	addi	a1,a1,1980 # 6618 <malloc+0x6da>
     e64:	00005517          	auipc	a0,0x5
     e68:	7bc50513          	addi	a0,a0,1980 # 6620 <malloc+0x6e2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e7c:	7a058593          	addi	a1,a1,1952 # 6618 <malloc+0x6da>
     e80:	00006517          	auipc	a0,0x6
     e84:	8a850513          	addi	a0,a0,-1880 # 6728 <malloc+0x7ea>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     ea6:	78650513          	addi	a0,a0,1926 # 6628 <malloc+0x6ea>
     eaa:	00005097          	auipc	ra,0x5
     eae:	fd8080e7          	jalr	-40(ra) # 5e82 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     ec2:	78250513          	addi	a0,a0,1922 # 6640 <malloc+0x702>
     ec6:	00005097          	auipc	ra,0x5
     eca:	fbc080e7          	jalr	-68(ra) # 5e82 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ede:	77e50513          	addi	a0,a0,1918 # 6658 <malloc+0x71a>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	fa0080e7          	jalr	-96(ra) # 5e82 <printf>
    exit(1);
     eea:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     efa:	78250513          	addi	a0,a0,1922 # 6678 <malloc+0x73a>
     efe:	00005097          	auipc	ra,0x5
     f02:	f84080e7          	jalr	-124(ra) # 5e82 <printf>
    exit(1);
     f06:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     f16:	79650513          	addi	a0,a0,1942 # 66a8 <malloc+0x76a>
     f1a:	00005097          	auipc	ra,0x5
     f1e:	f68080e7          	jalr	-152(ra) # 5e82 <printf>
    exit(1);
     f22:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f32:	79250513          	addi	a0,a0,1938 # 66c0 <malloc+0x782>
     f36:	00005097          	auipc	ra,0x5
     f3a:	f4c080e7          	jalr	-180(ra) # 5e82 <printf>
    exit(1);
     f3e:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f4e:	78e50513          	addi	a0,a0,1934 # 66d8 <malloc+0x79a>
     f52:	00005097          	auipc	ra,0x5
     f56:	f30080e7          	jalr	-208(ra) # 5e82 <printf>
    exit(1);
     f5a:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f6a:	79a50513          	addi	a0,a0,1946 # 6700 <malloc+0x7c2>
     f6e:	00005097          	auipc	ra,0x5
     f72:	f14080e7          	jalr	-236(ra) # 5e82 <printf>
    exit(1);
     f76:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f86:	7ae50513          	addi	a0,a0,1966 # 6730 <malloc+0x7f2>
     f8a:	00005097          	auipc	ra,0x5
     f8e:	ef8080e7          	jalr	-264(ra) # 5e82 <printf>
    exit(1);
     f92:	4505                	li	a0,1
...
0000000000000f9c <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff2:	762a0a13          	addi	s4,s4,1890 # 6750 <malloc+0x812>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1042:	71250513          	addi	a0,a0,1810 # 6750 <malloc+0x812>
  ...
  for(i = 0; i < N; i++){
    ...
    10b6:	6a650513          	addi	a0,a0,1702 # 6758 <malloc+0x81a>
    10ba:	00005097          	auipc	ra,0x5
    10be:	dc8080e7          	jalr	-568(ra) # 5e82 <printf>
    exit(1);
    10c2:	4505                	li	a0,1
    ...
    10d6:	6a650513          	addi	a0,a0,1702 # 6778 <malloc+0x83a>
    10da:	00005097          	auipc	ra,0x5
    10de:	da8080e7          	jalr	-600(ra) # 5e82 <printf>
      exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6aa50513          	addi	a0,a0,1706 # 6798 <malloc+0x85a>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	d8c080e7          	jalr	-628(ra) # 5e82 <printf>
      exit(1);
    10fe:	4505                	li	a0,1
...
0000000000001108 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1124:	69898993          	addi	s3,s3,1688 # 67b8 <malloc+0x87a>
    1128:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1160:	66c50513          	addi	a0,a0,1644 # 67c8 <malloc+0x88a>
    1164:	00005097          	auipc	ra,0x5
    1168:	d1e080e7          	jalr	-738(ra) # 5e82 <printf>
      exit(1);
    116c:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    118e:	b5b48493          	addi	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea06db>
...
badarg(char *s)
{
    ...
    11ca:	35048493          	addi	s1,s1,848 # c350 <uninit+0x15f0>
  for(int i = 0; i < 50000; i++){
    ...
    11dc:	e9898993          	addi	s3,s3,-360 # 6070 <malloc+0x132>
    argv[0] = (char*)0xffffffff;
...
0000000000001202 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1264:	76078793          	addi	a5,a5,1888 # 79c0 <malloc+0x1a82>
  ...
  if(pid == 0){
    ...
    1296:	00009797          	auipc	a5,0x9
    129a:	ac278793          	addi	a5,a5,-1342 # 9d58 <big.0>
    129e:	0000a697          	auipc	a3,0xa
    12a2:	aba68693          	addi	a3,a3,-1350 # ad58 <__global_pointer$+0x908>
      big[i] = 'x';
    ...
    big[PGSIZE] = '\0';
    12b4:	0000a797          	auipc	a5,0xa
    12b8:	aa078223          	sb	zero,-1372(a5) # ad58 <__global_pointer$+0x908>
    char *args2[] = { big, big, big, 0 };
    12bc:	00007797          	auipc	a5,0x7
    12c0:	14c78793          	addi	a5,a5,332 # 8408 <malloc+0x24ca>
    ...
    12e4:	d9050513          	addi	a0,a0,-624 # 6070 <malloc+0x132>
    ...
    12fc:	57850513          	addi	a0,a0,1400 # 6870 <malloc+0x932>
    1300:	00005097          	auipc	ra,0x5
    1304:	b82080e7          	jalr	-1150(ra) # 5e82 <printf>
      exit(1);
    1308:	4505                	li	a0,1
    ...
    131c:	4d050513          	addi	a0,a0,1232 # 67e8 <malloc+0x8aa>
    1320:	00005097          	auipc	ra,0x5
    1324:	b62080e7          	jalr	-1182(ra) # 5e82 <printf>
    exit(1);
    1328:	4505                	li	a0,1
    ...
    133c:	4d050513          	addi	a0,a0,1232 # 6808 <malloc+0x8ca>
    1340:	00005097          	auipc	ra,0x5
    1344:	b42080e7          	jalr	-1214(ra) # 5e82 <printf>
    exit(1);
    1348:	4505                	li	a0,1
    ...
    135e:	4ce50513          	addi	a0,a0,1230 # 6828 <malloc+0x8ea>
    1362:	00005097          	auipc	ra,0x5
    1366:	b20080e7          	jalr	-1248(ra) # 5e82 <printf>
    exit(1);
    136a:	4505                	li	a0,1
    ...
    137e:	4d650513          	addi	a0,a0,1238 # 6850 <malloc+0x912>
    1382:	00005097          	auipc	ra,0x5
    1386:	b00080e7          	jalr	-1280(ra) # 5e82 <printf>
    exit(1);
    138a:	4505                	li	a0,1
    ...
    1398:	95450513          	addi	a0,a0,-1708 # 6ce8 <malloc+0xdaa>
    139c:	00005097          	auipc	ra,0x5
    13a0:	ae6080e7          	jalr	-1306(ra) # 5e82 <printf>
    exit(1);
    13a4:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    13e2:	4ba50513          	addi	a0,a0,1210 # 6898 <malloc+0x95a>
    13e6:	00005097          	auipc	ra,0x5
    13ea:	a9c080e7          	jalr	-1380(ra) # 5e82 <printf>
    exit(1);
    13ee:	4505                	li	a0,1
...
00000000000013f8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    140c:	cc050513          	addi	a0,a0,-832 # 60c8 <malloc+0x18a>
  ...
  if(pid == 0){
    ...
    1448:	c8498993          	addi	s3,s3,-892 # 60c8 <malloc+0x18a>
      int n = write(fd, "1234567890", 10);
    144c:	4a29                	li	s4,10
    144e:	00005b97          	auipc	s7,0x5
    1452:	4aab8b93          	addi	s7,s7,1194 # 68f8 <malloc+0x9ba>
    ...
    14d4:	3f850513          	addi	a0,a0,1016 # 68c8 <malloc+0x98a>
    14d8:	00005097          	auipc	ra,0x5
    14dc:	9aa080e7          	jalr	-1622(ra) # 5e82 <printf>
    exit(1);
    14e0:	4505                	li	a0,1
    ...
    14f0:	3f450513          	addi	a0,a0,1012 # 68e0 <malloc+0x9a2>
    14f4:	00005097          	auipc	ra,0x5
    14f8:	98e080e7          	jalr	-1650(ra) # 5e82 <printf>
        exit(1);
    14fc:	4505                	li	a0,1
    ...
    150e:	3fe50513          	addi	a0,a0,1022 # 6908 <malloc+0x9ca>
    1512:	00005097          	auipc	ra,0x5
    1516:	970080e7          	jalr	-1680(ra) # 5e82 <printf>
        exit(1);
    151a:	4505                	li	a0,1
    ...
    153c:	b90a0a13          	addi	s4,s4,-1136 # 60c8 <malloc+0x18a>
    int n = write(fd, "xxx", 3);
    1540:	498d                	li	s3,3
    1542:	00005b97          	auipc	s7,0x5
    1546:	3e6b8b93          	addi	s7,s7,998 # 6928 <malloc+0x9ea>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    154a:	85da                	mv	a1,s6
    154c:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1590:	b3c50513          	addi	a0,a0,-1220 # 60c8 <malloc+0x18a>
  ...
  exit(xstatus);
    ...
    15b2:	33250513          	addi	a0,a0,818 # 68e0 <malloc+0x9a2>
    15b6:	00005097          	auipc	ra,0x5
    15ba:	8cc080e7          	jalr	-1844(ra) # 5e82 <printf>
      exit(1);
    15be:	4505                	li	a0,1
    ...
    15d4:	36050513          	addi	a0,a0,864 # 6930 <malloc+0x9f2>
    15d8:	00005097          	auipc	ra,0x5
    15dc:	8aa080e7          	jalr	-1878(ra) # 5e82 <printf>
      exit(1);
    15e0:	4505                	li	a0,1
...
00000000000015ea <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    15fa:	a7a78793          	addi	a5,a5,-1414 # 6070 <malloc+0x132>
    15fe:	fcf43023          	sd	a5,-64(s0)
    1602:	00005797          	auipc	a5,0x5
    1606:	34e78793          	addi	a5,a5,846 # 6950 <malloc+0xa12>
    160a:	fcf43423          	sd	a5,-56(s0)
    160e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1612:	00005517          	auipc	a0,0x5
    1616:	34650513          	addi	a0,a0,838 # 6958 <malloc+0xa1a>
  ...
  if(pid == 0) {
    ...
    1646:	31650513          	addi	a0,a0,790 # 6958 <malloc+0xa1a>
    ...
    1662:	31a50513          	addi	a0,a0,794 # 6978 <malloc+0xa3a>
    1666:	00005097          	auipc	ra,0x5
    166a:	81c080e7          	jalr	-2020(ra) # 5e82 <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    1680:	24c50513          	addi	a0,a0,588 # 68c8 <malloc+0x98a>
    1684:	00004097          	auipc	ra,0x4
    1688:	7fe080e7          	jalr	2046(ra) # 5e82 <printf>
     exit(1);
    168c:	4505                	li	a0,1
    ...
    169c:	2c850513          	addi	a0,a0,712 # 6960 <malloc+0xa22>
    16a0:	00004097          	auipc	ra,0x4
    16a4:	7e2080e7          	jalr	2018(ra) # 5e82 <printf>
      exit(1);
    16a8:	4505                	li	a0,1
    ...
    16ba:	9ba50513          	addi	a0,a0,-1606 # 6070 <malloc+0x132>
  ...
  if(xstatus != 0)
    ...
    16ee:	29e50513          	addi	a0,a0,670 # 6988 <malloc+0xa4a>
    16f2:	00004097          	auipc	ra,0x4
    16f6:	790080e7          	jalr	1936(ra) # 5e82 <printf>
      exit(1);
    16fa:	4505                	li	a0,1
    ...
    170a:	29a50513          	addi	a0,a0,666 # 69a0 <malloc+0xa62>
    170e:	00004097          	auipc	ra,0x4
    1712:	774080e7          	jalr	1908(ra) # 5e82 <printf>
    1716:	b7d1                	j	16da <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    1718:	4581                	li	a1,0
    171a:	00005517          	auipc	a0,0x5
    171e:	23e50513          	addi	a0,a0,574 # 6958 <malloc+0xa1a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1748:	ccc50513          	addi	a0,a0,-820 # 6410 <malloc+0x4d2>
    174c:	00004097          	auipc	ra,0x4
    1750:	736080e7          	jalr	1846(ra) # 5e82 <printf>
    exit(1);
    1754:	4505                	li	a0,1
    ...
    1764:	18050513          	addi	a0,a0,384 # 68e0 <malloc+0x9a2>
    1768:	00004097          	auipc	ra,0x4
    176c:	71a080e7          	jalr	1818(ra) # 5e82 <printf>
    exit(1);
    1770:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    177e:	1de50513          	addi	a0,a0,478 # 6958 <malloc+0xa1a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    17a8:	21450513          	addi	a0,a0,532 # 69b8 <malloc+0xa7a>
    17ac:	00004097          	auipc	ra,0x4
    17b0:	6d6080e7          	jalr	1750(ra) # 5e82 <printf>
    exit(1);
    17b4:	4505                	li	a0,1
...
00000000000017c8 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    180c:	0000ca97          	auipc	s5,0xc
    1810:	c64a8a93          	addi	s5,s5,-924 # d470 <buf>
    1814:	864e                	mv	a2,s3
    1816:	85d6                	mv	a1,s5
    ...
    1828:	0000c717          	auipc	a4,0xc
    182c:	c4870713          	addi	a4,a4,-952 # d470 <buf>
    ...
    186e:	16650513          	addi	a0,a0,358 # 69d0 <malloc+0xa92>
    1872:	00004097          	auipc	ra,0x4
    1876:	610080e7          	jalr	1552(ra) # 5e82 <printf>
    exit(1);
    187a:	4505                	li	a0,1
    ...
    for(n = 0; n < N; n++){
    189a:	0000cb97          	auipc	s7,0xc
    189e:	bd6b8b93          	addi	s7,s7,-1066 # d470 <buf>
    ...
    18b6:	42db0b13          	addi	s6,s6,1069 # 142d <truncate3+0x35>
{
    ...
    18fc:	0f050513          	addi	a0,a0,240 # 69e8 <malloc+0xaaa>
    1900:	00004097          	auipc	ra,0x4
    1904:	582080e7          	jalr	1410(ra) # 5e82 <printf>
        exit(1);
    1908:	4505                	li	a0,1
    ...
    1918:	0ec50513          	addi	a0,a0,236 # 6a00 <malloc+0xac2>
    191c:	00004097          	auipc	ra,0x4
    1920:	566080e7          	jalr	1382(ra) # 5e82 <printf>
          return;
    ...
    194c:	0d050513          	addi	a0,a0,208 # 6a18 <malloc+0xada>
    1950:	00004097          	auipc	ra,0x4
    1954:	532080e7          	jalr	1330(ra) # 5e82 <printf>
      exit(1);
    1958:	4505                	li	a0,1
    ...
    199c:	0a050513          	addi	a0,a0,160 # 6a38 <malloc+0xafa>
    19a0:	00004097          	auipc	ra,0x4
    19a4:	4e2080e7          	jalr	1250(ra) # 5e82 <printf>
    exit(1);
    19a8:	4505                	li	a0,1
...
00000000000019b2 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1a14:	eb850513          	addi	a0,a0,-328 # 68c8 <malloc+0x98a>
    1a18:	00004097          	auipc	ra,0x4
    1a1c:	46a080e7          	jalr	1130(ra) # 5e82 <printf>
      exit(1);
    1a20:	4505                	li	a0,1
    ...
    1a30:	02450513          	addi	a0,a0,36 # 6a50 <malloc+0xb12>
    1a34:	00004097          	auipc	ra,0x4
    1a38:	44e080e7          	jalr	1102(ra) # 5e82 <printf>
        exit(1);
    1a3c:	4505                	li	a0,1
    ...
    1a4c:	02050513          	addi	a0,a0,32 # 6a68 <malloc+0xb2a>
    1a50:	00004097          	auipc	ra,0x4
    1a54:	432080e7          	jalr	1074(ra) # 5e82 <printf>
        exit(1);
    1a58:	4505                	li	a0,1
...
0000000000001a6c <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1ac4:	e0850513          	addi	a0,a0,-504 # 68c8 <malloc+0x98a>
    1ac8:	00004097          	auipc	ra,0x4
    1acc:	3ba080e7          	jalr	954(ra) # 5e82 <printf>
      exit(1);
    1ad0:	4505                	li	a0,1
    ...
    1ae8:	de450513          	addi	a0,a0,-540 # 68c8 <malloc+0x98a>
    1aec:	00004097          	auipc	ra,0x4
    1af0:	396080e7          	jalr	918(ra) # 5e82 <printf>
        exit(1);
    1af4:	4505                	li	a0,1
...
0000000000001b06 <forkfork>:
{
    ...
    1b62:	f2a50513          	addi	a0,a0,-214 # 6a88 <malloc+0xb4a>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	31c080e7          	jalr	796(ra) # 5e82 <printf>
      exit(1);
    1b6e:	4505                	li	a0,1
    ...
    1b74:	fb4080e7          	jalr	-76(ra) # 5b24 <exit>
{
    ...
    1bba:	ee250513          	addi	a0,a0,-286 # 6a98 <malloc+0xb5a>
    1bbe:	00004097          	auipc	ra,0x4
    1bc2:	2c4080e7          	jalr	708(ra) # 5e82 <printf>
      exit(1);
    1bc6:	4505                	li	a0,1
...
0000000000001bd0 <reparent2>:
{
  ...
  exit(0);
    ...
    1c08:	0e450513          	addi	a0,a0,228 # 6ce8 <malloc+0xdaa>
    1c0c:	00004097          	auipc	ra,0x4
    1c10:	276080e7          	jalr	630(ra) # 5e82 <printf>
      exit(1);
    1c14:	4505                	li	a0,1
...
0000000000001c38 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1caa:	04250513          	addi	a0,a0,66 # 6ce8 <malloc+0xdaa>
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	1d4080e7          	jalr	468(ra) # 5e82 <printf>
      exit(1);
    1cb6:	4505                	li	a0,1
    ...
    1cde:	c8650513          	addi	a0,a0,-890 # 6960 <malloc+0xa22>
    1ce2:	00004097          	auipc	ra,0x4
    1ce6:	1a0080e7          	jalr	416(ra) # 5e82 <printf>
          exit(1);
    1cea:	4505                	li	a0,1
    ...
    1d56:	d6650513          	addi	a0,a0,-666 # 6ab8 <malloc+0xb7a>
    1d5a:	00004097          	auipc	ra,0x4
    1d5e:	128080e7          	jalr	296(ra) # 5e82 <printf>
            exit(1);
    1d62:	4505                	li	a0,1
    ...
    1d80:	d5450513          	addi	a0,a0,-684 # 6ad0 <malloc+0xb92>
    1d84:	00004097          	auipc	ra,0x4
    1d88:	0fe080e7          	jalr	254(ra) # 5e82 <printf>
        exit(1);
    1d8c:	4505                	li	a0,1
    ...
    1de0:	d1c50513          	addi	a0,a0,-740 # 6af8 <malloc+0xbba>
    1de4:	00004097          	auipc	ra,0x4
    1de8:	09e080e7          	jalr	158(ra) # 5e82 <printf>
        exit(1);
    1dec:	4505                	li	a0,1
...
0000000000001e64 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e86:	25e50513          	addi	a0,a0,606 # 60e0 <malloc+0x1a2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1eb0:	e6da8a9b          	addiw	s5,s5,-403 # 41c64e6d <__BSS_END__+0x41c549ed>
    1eb4:	6a0d                	lui	s4,0x3
    1eb6:	039a0a1b          	addiw	s4,s4,57 # 3039 <fourteen+0x129>
    if((x % 3) == 0){
    1eba:	000ab9b7          	lui	s3,0xab
    1ebe:	aab98993          	addi	s3,s3,-1365 # aaaab <__BSS_END__+0x9a62b>
    ...
    1ece:	216b0b13          	addi	s6,s6,534 # 60e0 <malloc+0x1a2>
      link("cat", "x");
    1ed2:	00005c97          	auipc	s9,0x5
    1ed6:	c4ec8c93          	addi	s9,s9,-946 # 6b20 <malloc+0xbe2>
    ...
    1ee6:	9e650513          	addi	a0,a0,-1562 # 68c8 <malloc+0x98a>
    1eea:	00004097          	auipc	ra,0x4
    1eee:	f98080e7          	jalr	-104(ra) # 5e82 <printf>
    exit(1);
    1ef2:	4505                	li	a0,1
...
0000000000001f86 <manywrites>:
{
  ...
  exit(0);
    ...
    1ff8:	cf450513          	addi	a0,a0,-780 # 6ce8 <malloc+0xdaa>
    1ffc:	00004097          	auipc	ra,0x4
    2000:	e86080e7          	jalr	-378(ra) # 5e82 <printf>
      exit(1);
    2004:	4505                	li	a0,1
    ...
    2046:	0000bc97          	auipc	s9,0xb
    204a:	42ac8c93          	addi	s9,s9,1066 # d470 <buf>
    ...
    20b4:	a7850513          	addi	a0,a0,-1416 # 6b28 <malloc+0xbea>
    20b8:	00004097          	auipc	ra,0x4
    20bc:	dca080e7          	jalr	-566(ra) # 5e82 <printf>
            exit(1);
    20c0:	4505                	li	a0,1
    ...
    20d4:	07050513          	addi	a0,a0,112 # 6140 <malloc+0x202>
    20d8:	00004097          	auipc	ra,0x4
    20dc:	daa080e7          	jalr	-598(ra) # 5e82 <printf>
            exit(1);
    20e0:	4505                	li	a0,1
...
00000000000020fe <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    212e:	a5e50513          	addi	a0,a0,-1442 # 6b88 <malloc+0xc4a>
    2132:	00004097          	auipc	ra,0x4
    2136:	d50080e7          	jalr	-688(ra) # 5e82 <printf>
    exit(1);
    213a:	4505                	li	a0,1
    ...
    2152:	9f250513          	addi	a0,a0,-1550 # 6b40 <malloc+0xc02>
    2156:	00004097          	auipc	ra,0x4
    215a:	d2c080e7          	jalr	-724(ra) # 5e82 <printf>
    exit(1);
    215e:	4505                	li	a0,1
    ...
    216e:	9ee50513          	addi	a0,a0,-1554 # 6b58 <malloc+0xc1a>
    2172:	00004097          	auipc	ra,0x4
    2176:	d10080e7          	jalr	-752(ra) # 5e82 <printf>
      exit(1);
    217a:	4505                	li	a0,1
    ...
    218a:	9ea50513          	addi	a0,a0,-1558 # 6b70 <malloc+0xc32>
    218e:	00004097          	auipc	ra,0x4
    2192:	cf4080e7          	jalr	-780(ra) # 5e82 <printf>
    exit(1);
    2196:	4505                	li	a0,1
...
00000000000021d4 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21f6:	35098993          	addi	s3,s3,848 # c350 <uninit+0x15f0>
    21fa:	1003d937          	lui	s2,0x1003d
    21fe:	090e                	slli	s2,s2,0x3
    2200:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002d000>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2244:	68850513          	addi	a0,a0,1672 # 68c8 <malloc+0x98a>
    2248:	00004097          	auipc	ra,0x4
    224c:	c3a080e7          	jalr	-966(ra) # 5e82 <printf>
      exit(1);
    2250:	4505                	li	a0,1
    ...
    2266:	94e50513          	addi	a0,a0,-1714 # 6bb0 <malloc+0xc72>
    226a:	00004097          	auipc	ra,0x4
    226e:	c18080e7          	jalr	-1000(ra) # 5e82 <printf>
      exit(1);
    2272:	4505                	li	a0,1
...
0000000000002286 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22ee:	5de50513          	addi	a0,a0,1502 # 68c8 <malloc+0x98a>
    22f2:	00004097          	auipc	ra,0x4
    22f6:	b90080e7          	jalr	-1136(ra) # 5e82 <printf>
      exit(1);
    22fa:	4505                	li	a0,1
    ...
    231a:	8ba50513          	addi	a0,a0,-1862 # 6bd0 <malloc+0xc92>
    231e:	00004097          	auipc	ra,0x4
    2322:	b64080e7          	jalr	-1180(ra) # 5e82 <printf>
      exit(1);
    2326:	4505                	li	a0,1
...
000000000000233a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    234a:	8a250513          	addi	a0,a0,-1886 # 6be8 <malloc+0xcaa>
  ...
  fd = open("bigarg-ok", 0);
    ...
    237c:	87050513          	addi	a0,a0,-1936 # 6be8 <malloc+0xcaa>
  ...
  close(fd);
    ...
    239c:	8082                	ret
    239e:	00008797          	auipc	a5,0x8
    23a2:	8ba78793          	addi	a5,a5,-1862 # 9c58 <args.1>
    23a6:	00008697          	auipc	a3,0x8
    23aa:	9aa68693          	addi	a3,a3,-1622 # 9d50 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    23ae:	00005717          	auipc	a4,0x5
    23b2:	84a70713          	addi	a4,a4,-1974 # 6bf8 <malloc+0xcba>
    23b6:	e398                	sd	a4,0(a5)
    for(i = 0; i < MAXARG-1; i++)
    23b8:	07a1                	addi	a5,a5,8
    23ba:	fed79ee3          	bne	a5,a3,23b6 <bigargtest+0x7c>
    args[MAXARG-1] = 0;
    23be:	00008597          	auipc	a1,0x8
    23c2:	89a58593          	addi	a1,a1,-1894 # 9c58 <args.1>
    23c6:	0e05bc23          	sd	zero,248(a1)
    exec("echo", args);
    23ca:	00004517          	auipc	a0,0x4
    23ce:	ca650513          	addi	a0,a0,-858 # 6070 <malloc+0x132>
    23d2:	00003097          	auipc	ra,0x3
    23d6:	78a080e7          	jalr	1930(ra) # 5b5c <exec>
    fd = open("bigarg-ok", O_CREATE);
    23da:	20000593          	li	a1,512
    23de:	00005517          	auipc	a0,0x5
    23e2:	80a50513          	addi	a0,a0,-2038 # 6be8 <malloc+0xcaa>
    ...
    2406:	8d650513          	addi	a0,a0,-1834 # 6cd8 <malloc+0xd9a>
    240a:	00004097          	auipc	ra,0x4
    240e:	a78080e7          	jalr	-1416(ra) # 5e82 <printf>
    exit(1);
    2412:	4505                	li	a0,1
    ...
    242a:	8d250513          	addi	a0,a0,-1838 # 6cf8 <malloc+0xdba>
    242e:	00004097          	auipc	ra,0x4
    2432:	a54080e7          	jalr	-1452(ra) # 5e82 <printf>
    exit(1);
    2436:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    247e:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffeeb80>
    2482:	85a6                	mv	a1,s1
    2484:	00005517          	auipc	a0,0x5
    2488:	89450513          	addi	a0,a0,-1900 # 6d18 <malloc+0xdda>
    248c:	00004097          	auipc	ra,0x4
    2490:	9f6080e7          	jalr	-1546(ra) # 5e82 <printf>
    exit(1);
    2494:	4505                	li	a0,1
    ...
    24a4:	42850513          	addi	a0,a0,1064 # 68c8 <malloc+0x98a>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	9da080e7          	jalr	-1574(ra) # 5e82 <printf>
    exit(1);
    24b0:	4505                	li	a0,1
...
00000000000024c4 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    253e:	48678793          	addi	a5,a5,1158 # 79c0 <malloc+0x1a82>
  ...
  if(ret != -1){
    ...
    2582:	7c250513          	addi	a0,a0,1986 # 6d40 <malloc+0xe02>
    2586:	00004097          	auipc	ra,0x4
    258a:	8fc080e7          	jalr	-1796(ra) # 5e82 <printf>
    exit(1);
    258e:	4505                	li	a0,1
    ...
    25a0:	24c50513          	addi	a0,a0,588 # 67e8 <malloc+0x8aa>
    25a4:	00004097          	auipc	ra,0x4
    25a8:	8de080e7          	jalr	-1826(ra) # 5e82 <printf>
    exit(1);
    25ac:	4505                	li	a0,1
    ...
    25be:	24e50513          	addi	a0,a0,590 # 6808 <malloc+0x8ca>
    25c2:	00004097          	auipc	ra,0x4
    25c6:	8c0080e7          	jalr	-1856(ra) # 5e82 <printf>
    exit(1);
    25ca:	4505                	li	a0,1
    ...
    25de:	24e50513          	addi	a0,a0,590 # 6828 <malloc+0x8ea>
    25e2:	00004097          	auipc	ra,0x4
    25e6:	8a0080e7          	jalr	-1888(ra) # 5e82 <printf>
    exit(1);
    25ea:	4505                	li	a0,1
    ...
    25fc:	25850513          	addi	a0,a0,600 # 6850 <malloc+0x912>
    2600:	00004097          	auipc	ra,0x4
    2604:	882080e7          	jalr	-1918(ra) # 5e82 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
0000000000002612 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2648:	73c50513          	addi	a0,a0,1852 # 6d80 <malloc+0xe42>
  ...
  if(n >= 0){
    ...
    2678:	72c50513          	addi	a0,a0,1836 # 6da0 <malloc+0xe62>
    267c:	00004097          	auipc	ra,0x4
    2680:	806080e7          	jalr	-2042(ra) # 5e82 <printf>
    exit(1);
    2684:	4505                	li	a0,1
    ...
    2696:	6b650513          	addi	a0,a0,1718 # 6d48 <malloc+0xe0a>
    269a:	00003097          	auipc	ra,0x3
    269e:	7e8080e7          	jalr	2024(ra) # 5e82 <printf>
    exit(1);
    26a2:	4505                	li	a0,1
    ...
    26b2:	6b250513          	addi	a0,a0,1714 # 6d60 <malloc+0xe22>
    26b6:	00003097          	auipc	ra,0x3
    26ba:	7cc080e7          	jalr	1996(ra) # 5e82 <printf>
    exit(1);
    26be:	4505                	li	a0,1
    ...
    26cc:	6c050513          	addi	a0,a0,1728 # 6d88 <malloc+0xe4a>
    26d0:	00003097          	auipc	ra,0x3
    26d4:	7b2080e7          	jalr	1970(ra) # 5e82 <printf>
    exit(1);
    26d8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    26f0:	69450513          	addi	a0,a0,1684 # 6d80 <malloc+0xe42>
    26f4:	00003097          	auipc	ra,0x3
    26f8:	480080e7          	jalr	1152(ra) # 5b74 <unlink>
  fd = open("README", O_RDONLY);
    26fc:	4581                	li	a1,0
    26fe:	00004517          	auipc	a0,0x4
    2702:	b1a50513          	addi	a0,a0,-1254 # 6218 <malloc+0x2da>
  ...
  if(n >= 0){
    ...
    272c:	6a850513          	addi	a0,a0,1704 # 6dd0 <malloc+0xe92>
    2730:	00003097          	auipc	ra,0x3
    2734:	752080e7          	jalr	1874(ra) # 5e82 <printf>
    exit(1);
    2738:	4505                	li	a0,1
    ...
    2746:	64650513          	addi	a0,a0,1606 # 6d88 <malloc+0xe4a>
    274a:	00003097          	auipc	ra,0x3
    274e:	738080e7          	jalr	1848(ra) # 5e82 <printf>
    exit(1);
    2752:	4505                	li	a0,1
...
0000000000002770 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    27ae:	6705                	lui	a4,0x1
      *b = 99;
    27b0:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3ffefb80>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    27d0:	62c50513          	addi	a0,a0,1580 # 6df8 <malloc+0xeba>
    27d4:	00003097          	auipc	ra,0x3
    27d8:	6ae080e7          	jalr	1710(ra) # 5e82 <printf>
    exit(1);
    27dc:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    283c:	5e050513          	addi	a0,a0,1504 # 6e18 <malloc+0xeda>
    2840:	00003097          	auipc	ra,0x3
    2844:	642080e7          	jalr	1602(ra) # 5e82 <printf>
    exit(1);
    2848:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    289e:	5de50513          	addi	a0,a0,1502 # 6e78 <malloc+0xf3a>
    28a2:	00003097          	auipc	ra,0x3
    28a6:	5e0080e7          	jalr	1504(ra) # 5e82 <printf>
    exit(1);
    28aa:	4505                	li	a0,1
    ...
    28c0:	57c50513          	addi	a0,a0,1404 # 6e38 <malloc+0xefa>
    28c4:	00003097          	auipc	ra,0x3
    28c8:	5be080e7          	jalr	1470(ra) # 5e82 <printf>
      exit(1);
    28cc:	4505                	li	a0,1
    ...
    28dc:	58050513          	addi	a0,a0,1408 # 6e58 <malloc+0xf1a>
    28e0:	00003097          	auipc	ra,0x3
    28e4:	5a2080e7          	jalr	1442(ra) # 5e82 <printf>
    exit(1);
    28e8:	4505                	li	a0,1
...
0000000000002918 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    297a:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63efb7f>
  a = sbrk(0);
    297e:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    29de:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63efb7f>
  ...
  if(c != a){
    ...
    2a26:	47650513          	addi	a0,a0,1142 # 6e98 <malloc+0xf5a>
    2a2a:	00003097          	auipc	ra,0x3
    2a2e:	458080e7          	jalr	1112(ra) # 5e82 <printf>
    exit(1);
    2a32:	4505                	li	a0,1
    ...
    2a42:	4a250513          	addi	a0,a0,1186 # 6ee0 <malloc+0xfa2>
    2a46:	00003097          	auipc	ra,0x3
    2a4a:	43c080e7          	jalr	1084(ra) # 5e82 <printf>
    exit(1);
    2a4e:	4505                	li	a0,1
    ...
    2a62:	4a250513          	addi	a0,a0,1186 # 6f00 <malloc+0xfc2>
    2a66:	00003097          	auipc	ra,0x3
    2a6a:	41c080e7          	jalr	1052(ra) # 5e82 <printf>
    exit(1);
    2a6e:	4505                	li	a0,1
    ...
    2a82:	4c250513          	addi	a0,a0,1218 # 6f40 <malloc+0x1002>
    2a86:	00003097          	auipc	ra,0x3
    2a8a:	3fc080e7          	jalr	1020(ra) # 5e82 <printf>
    exit(1);
    2a8e:	4505                	li	a0,1
    ...
    2a9e:	4d650513          	addi	a0,a0,1238 # 6f70 <malloc+0x1032>
    2aa2:	00003097          	auipc	ra,0x3
    2aa6:	3e0080e7          	jalr	992(ra) # 5e82 <printf>
    exit(1);
    2aaa:	4505                	li	a0,1
    ...
    2abe:	4ee50513          	addi	a0,a0,1262 # 6fa8 <malloc+0x106a>
    2ac2:	00003097          	auipc	ra,0x3
    2ac6:	3c0080e7          	jalr	960(ra) # 5e82 <printf>
    exit(1);
    2aca:	4505                	li	a0,1
...
0000000000002ad4 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2af8:	4dc50513          	addi	a0,a0,1244 # 6fd0 <malloc+0x1092>
    2afc:	00003097          	auipc	ra,0x3
    2b00:	068080e7          	jalr	104(ra) # 5b64 <open>
    2b04:	84aa                	mv	s1,a0
  unlink("sbrk");
    2b06:	00004517          	auipc	a0,0x4
    2b0a:	4ca50513          	addi	a0,a0,1226 # 6fd0 <malloc+0x1092>
  ...
  if(pipe((int *) a) != 0){
    ...
    2b5e:	47e50513          	addi	a0,a0,1150 # 6fd8 <malloc+0x109a>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	320080e7          	jalr	800(ra) # 5e82 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7a:	47a50513          	addi	a0,a0,1146 # 6ff0 <malloc+0x10b2>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	304080e7          	jalr	772(ra) # 5e82 <printf>
    exit(1);
    2b86:	4505                	li	a0,1
    ...
    2b96:	e3e50513          	addi	a0,a0,-450 # 69d0 <malloc+0xa92>
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	2e8080e7          	jalr	744(ra) # 5e82 <printf>
    exit(1);
    2ba2:	4505                	li	a0,1
...
0000000000002bac <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2bc0:	44c50513          	addi	a0,a0,1100 # 7008 <malloc+0x10ca>
  ...
  close(fd);
    ...
    2c08:	cdc50513          	addi	a0,a0,-804 # 68e0 <malloc+0x9a2>
    2c0c:	00003097          	auipc	ra,0x3
    2c10:	276080e7          	jalr	630(ra) # 5e82 <printf>
    exit(1);
    2c14:	4505                	li	a0,1
...
0000000000002c1e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2c56:	09650513          	addi	a0,a0,150 # 6ce8 <malloc+0xdaa>
    2c5a:	00003097          	auipc	ra,0x3
    2c5e:	228080e7          	jalr	552(ra) # 5e82 <printf>
    exit(1);
    2c62:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2cac:	04050513          	addi	a0,a0,64 # 6ce8 <malloc+0xdaa>
    2cb0:	00003097          	auipc	ra,0x3
    2cb4:	1d2080e7          	jalr	466(ra) # 5e82 <printf>
    exit(1);
    2cb8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ce4:	8007879b          	addiw	a5,a5,-2048 # a800 <__global_pointer$+0x3b0>
    ...
    2d0c:	fe050513          	addi	a0,a0,-32 # 6ce8 <malloc+0xdaa>
    2d10:	00003097          	auipc	ra,0x3
    2d14:	172080e7          	jalr	370(ra) # 5e82 <printf>
    exit(1);
    2d18:	4505                	li	a0,1
...
0000000000002e0a <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2e16:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7ffefb84>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2e88:	e6450513          	addi	a0,a0,-412 # 6ce8 <malloc+0xdaa>
    2e8c:	00003097          	auipc	ra,0x3
    2e90:	ff6080e7          	jalr	-10(ra) # 5e82 <printf>
      exit(1);
    2e94:	4505                	li	a0,1
    ...
    2ee2:	19250513          	addi	a0,a0,402 # 6070 <malloc+0x132>
    2ee6:	faa43423          	sd	a0,-88(s0)
    2eea:	00003797          	auipc	a5,0x3
    2eee:	1f678793          	addi	a5,a5,502 # 60e0 <malloc+0x1a2>
...
0000000000002f10 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2f20:	2c450513          	addi	a0,a0,708 # 71e0 <malloc+0x12a2>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2f32:	10a50513          	addi	a0,a0,266 # 7038 <malloc+0x10fa>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2f48:	14c50513          	addi	a0,a0,332 # 7090 <malloc+0x1152>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2f66:	1a650513          	addi	a0,a0,422 # 7108 <malloc+0x11ca>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2f82:	1fa50513          	addi	a0,a0,506 # 7178 <malloc+0x123a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2f94:	24050513          	addi	a0,a0,576 # 71d0 <malloc+0x1292>
  ...
  unlink("123456789012345/12345678901234");
    ...
    2fa6:	22e50513          	addi	a0,a0,558 # 71d0 <malloc+0x1292>
  ...
  unlink("12345678901234");
    ...
    3012:	00250513          	addi	a0,a0,2 # 7010 <malloc+0x10d2>
    3016:	00003097          	auipc	ra,0x3
    301a:	e6c080e7          	jalr	-404(ra) # 5e82 <printf>
    exit(1);
    301e:	4505                	li	a0,1
    ...
    302e:	02e50513          	addi	a0,a0,46 # 7058 <malloc+0x111a>
    3032:	00003097          	auipc	ra,0x3
    3036:	e50080e7          	jalr	-432(ra) # 5e82 <printf>
    exit(1);
    303a:	4505                	li	a0,1
    ...
    304a:	07a50513          	addi	a0,a0,122 # 70c0 <malloc+0x1182>
    304e:	00003097          	auipc	ra,0x3
    3052:	e34080e7          	jalr	-460(ra) # 5e82 <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3066:	0d650513          	addi	a0,a0,214 # 7138 <malloc+0x11fa>
    306a:	00003097          	auipc	ra,0x3
    306e:	e18080e7          	jalr	-488(ra) # 5e82 <printf>
    exit(1);
    3072:	4505                	li	a0,1
    ...
    3082:	11a50513          	addi	a0,a0,282 # 7198 <malloc+0x125a>
    3086:	00003097          	auipc	ra,0x3
    308a:	dfc080e7          	jalr	-516(ra) # 5e82 <printf>
    exit(1);
    308e:	4505                	li	a0,1
    ...
    309e:	15650513          	addi	a0,a0,342 # 71f0 <malloc+0x12b2>
    30a2:	00003097          	auipc	ra,0x3
    30a6:	de0080e7          	jalr	-544(ra) # 5e82 <printf>
    exit(1);
    30aa:	4505                	li	a0,1
...
00000000000030b4 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    30c4:	16850513          	addi	a0,a0,360 # 7228 <malloc+0x12ea>
  ...
  if(chdir("iputdir") < 0){
    ...
    30d8:	15450513          	addi	a0,a0,340 # 7228 <malloc+0x12ea>
  ...
  if(unlink("../iputdir") < 0){
    ...
    30ec:	18050513          	addi	a0,a0,384 # 7268 <malloc+0x132a>
  ...
  if(chdir("/") < 0){
    ...
    3100:	19c50513          	addi	a0,a0,412 # 7298 <malloc+0x135a>
    ...
    3120:	11450513          	addi	a0,a0,276 # 7230 <malloc+0x12f2>
    3124:	00003097          	auipc	ra,0x3
    3128:	d5e080e7          	jalr	-674(ra) # 5e82 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	11050513          	addi	a0,a0,272 # 7248 <malloc+0x130a>
    3140:	00003097          	auipc	ra,0x3
    3144:	d42080e7          	jalr	-702(ra) # 5e82 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	12450513          	addi	a0,a0,292 # 7278 <malloc+0x133a>
    315c:	00003097          	auipc	ra,0x3
    3160:	d26080e7          	jalr	-730(ra) # 5e82 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	13050513          	addi	a0,a0,304 # 72a0 <malloc+0x1362>
    3178:	00003097          	auipc	ra,0x3
    317c:	d0a080e7          	jalr	-758(ra) # 5e82 <printf>
    exit(1);
    3180:	4505                	li	a0,1
...
000000000000318a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    31a8:	08450513          	addi	a0,a0,132 # 7228 <malloc+0x12ea>
    ...
    31bc:	07050513          	addi	a0,a0,112 # 7228 <malloc+0x12ea>
    ...
    31d0:	09c50513          	addi	a0,a0,156 # 7268 <malloc+0x132a>
    ...
    31f0:	6dc50513          	addi	a0,a0,1756 # 68c8 <malloc+0x98a>
    31f4:	00003097          	auipc	ra,0x3
    31f8:	c8e080e7          	jalr	-882(ra) # 5e82 <printf>
    exit(1);
    31fc:	4505                	li	a0,1
    ...
    320c:	02850513          	addi	a0,a0,40 # 7230 <malloc+0x12f2>
    3210:	00003097          	auipc	ra,0x3
    3214:	c72080e7          	jalr	-910(ra) # 5e82 <printf>
      exit(1);
    3218:	4505                	li	a0,1
    ...
    3228:	09450513          	addi	a0,a0,148 # 72b8 <malloc+0x137a>
    322c:	00003097          	auipc	ra,0x3
    3230:	c56080e7          	jalr	-938(ra) # 5e82 <printf>
      exit(1);
    3234:	4505                	li	a0,1
    ...
    3244:	03850513          	addi	a0,a0,56 # 7278 <malloc+0x133a>
    3248:	00003097          	auipc	ra,0x3
    324c:	c3a080e7          	jalr	-966(ra) # 5e82 <printf>
      exit(1);
    3250:	4505                	li	a0,1
...
0000000000003272 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3282:	05250513          	addi	a0,a0,82 # 72d0 <malloc+0x1392>
  ...
  if(chdir("dir0") < 0){
    ...
    3296:	03e50513          	addi	a0,a0,62 # 72d0 <malloc+0x1392>
  ...
  if(chdir("..") < 0){
    ...
    32aa:	04a50513          	addi	a0,a0,74 # 72f0 <malloc+0x13b2>
  ...
  if(unlink("dir0") < 0){
    ...
    32be:	01650513          	addi	a0,a0,22 # 72d0 <malloc+0x1392>
    ...
    32de:	f5650513          	addi	a0,a0,-170 # 7230 <malloc+0x12f2>
    32e2:	00003097          	auipc	ra,0x3
    32e6:	ba0080e7          	jalr	-1120(ra) # 5e82 <printf>
    exit(1);
    32ea:	4505                	li	a0,1
    ...
    32fa:	fe250513          	addi	a0,a0,-30 # 72d8 <malloc+0x139a>
    32fe:	00003097          	auipc	ra,0x3
    3302:	b84080e7          	jalr	-1148(ra) # 5e82 <printf>
    exit(1);
    3306:	4505                	li	a0,1
    ...
    3316:	fe650513          	addi	a0,a0,-26 # 72f8 <malloc+0x13ba>
    331a:	00003097          	auipc	ra,0x3
    331e:	b68080e7          	jalr	-1176(ra) # 5e82 <printf>
    exit(1);
    3322:	4505                	li	a0,1
    ...
    3332:	fe250513          	addi	a0,a0,-30 # 7310 <malloc+0x13d2>
    3336:	00003097          	auipc	ra,0x3
    333a:	b4c080e7          	jalr	-1204(ra) # 5e82 <printf>
    exit(1);
    333e:	4505                	li	a0,1
...
0000000000003348 <subdir>:
{
  ...
  unlink("ff");
    ...
    335a:	10250513          	addi	a0,a0,258 # 7458 <malloc+0x151a>
    335e:	00003097          	auipc	ra,0x3
    3362:	816080e7          	jalr	-2026(ra) # 5b74 <unlink>
  if(mkdir("dd") != 0){
    3366:	00004517          	auipc	a0,0x4
    336a:	fc250513          	addi	a0,a0,-62 # 7328 <malloc+0x13ea>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3382:	fca50513          	addi	a0,a0,-54 # 7348 <malloc+0x140a>
  ...
  write(fd, "ff", 2);
    ...
    339a:	0c258593          	addi	a1,a1,194 # 7458 <malloc+0x151a>
  ...
  if(unlink("dd") >= 0){
    ...
    33b4:	f7850513          	addi	a0,a0,-136 # 7328 <malloc+0x13ea>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    33c8:	fdc50513          	addi	a0,a0,-36 # 73a0 <malloc+0x1462>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    33e0:	fec50513          	addi	a0,a0,-20 # 73c8 <malloc+0x148a>
  ...
  write(fd, "FF", 2);
    ...
    33f8:	00458593          	addi	a1,a1,4 # 73f8 <malloc+0x14ba>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3414:	ff050513          	addi	a0,a0,-16 # 7400 <malloc+0x14c2>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    345c:	ff858593          	addi	a1,a1,-8 # 7450 <malloc+0x1512>
    3460:	00004517          	auipc	a0,0x4
    3464:	f6850513          	addi	a0,a0,-152 # 73c8 <malloc+0x148a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3478:	f5450513          	addi	a0,a0,-172 # 73c8 <malloc+0x148a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    348e:	f3e50513          	addi	a0,a0,-194 # 73c8 <malloc+0x148a>
  ...
  if(chdir("dd") != 0){
    ...
    34a2:	e8a50513          	addi	a0,a0,-374 # 7328 <malloc+0x13ea>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    34b6:	03650513          	addi	a0,a0,54 # 74e8 <malloc+0x15aa>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    34ca:	05250513          	addi	a0,a0,82 # 7518 <malloc+0x15da>
  ...
  if(chdir("./..") != 0){
    ...
    34de:	06e50513          	addi	a0,a0,110 # 7548 <malloc+0x160a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    34f4:	f6050513          	addi	a0,a0,-160 # 7450 <malloc+0x1512>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3508:	0000a597          	auipc	a1,0xa
    350c:	f6858593          	addi	a1,a1,-152 # d470 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    352e:	e9e50513          	addi	a0,a0,-354 # 73c8 <malloc+0x148a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3546:	09650513          	addi	a0,a0,150 # 75d8 <malloc+0x169a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    355e:	0ae50513          	addi	a0,a0,174 # 7608 <malloc+0x16ca>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3576:	db650513          	addi	a0,a0,-586 # 7328 <malloc+0x13ea>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    358c:	da050513          	addi	a0,a0,-608 # 7328 <malloc+0x13ea>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    35a2:	d8a50513          	addi	a0,a0,-630 # 7328 <malloc+0x13ea>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    35b6:	0e658593          	addi	a1,a1,230 # 7698 <malloc+0x175a>
    35ba:	00004517          	auipc	a0,0x4
    35be:	01e50513          	addi	a0,a0,30 # 75d8 <malloc+0x169a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    35d2:	0ca58593          	addi	a1,a1,202 # 7698 <malloc+0x175a>
    35d6:	00004517          	auipc	a0,0x4
    35da:	03250513          	addi	a0,a0,50 # 7608 <malloc+0x16ca>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    35ee:	e6658593          	addi	a1,a1,-410 # 7450 <malloc+0x1512>
    35f2:	00004517          	auipc	a0,0x4
    35f6:	d5650513          	addi	a0,a0,-682 # 7348 <malloc+0x140a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    360a:	fd250513          	addi	a0,a0,-46 # 75d8 <malloc+0x169a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    361e:	fee50513          	addi	a0,a0,-18 # 7608 <malloc+0x16ca>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3632:	e2250513          	addi	a0,a0,-478 # 7450 <malloc+0x1512>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3646:	fc650513          	addi	a0,a0,-58 # 7608 <malloc+0x16ca>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    365a:	f8250513          	addi	a0,a0,-126 # 75d8 <malloc+0x169a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    366e:	cde50513          	addi	a0,a0,-802 # 7348 <malloc+0x140a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3682:	16a50513          	addi	a0,a0,362 # 77e8 <malloc+0x18aa>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3696:	dbe50513          	addi	a0,a0,-578 # 7450 <malloc+0x1512>
  ...
  if(unlink("dd/ff") != 0){
    ...
    36aa:	ca250513          	addi	a0,a0,-862 # 7348 <malloc+0x140a>
  ...
  if(unlink("dd") == 0){
    ...
    36be:	c6e50513          	addi	a0,a0,-914 # 7328 <malloc+0x13ea>
  ...
  if(unlink("dd/dd") < 0){
    ...
    36d2:	18a50513          	addi	a0,a0,394 # 7858 <malloc+0x191a>
  ...
  if(unlink("dd") < 0){
    ...
    36e6:	c4650513          	addi	a0,a0,-954 # 7328 <malloc+0x13ea>
    ...
    3708:	c2c50513          	addi	a0,a0,-980 # 7330 <malloc+0x13f2>
    370c:	00002097          	auipc	ra,0x2
    3710:	776080e7          	jalr	1910(ra) # 5e82 <printf>
    exit(1);
    3714:	4505                	li	a0,1
    ...
    3724:	c3050513          	addi	a0,a0,-976 # 7350 <malloc+0x1412>
    3728:	00002097          	auipc	ra,0x2
    372c:	75a080e7          	jalr	1882(ra) # 5e82 <printf>
    exit(1);
    3730:	4505                	li	a0,1
    ...
    3740:	c3450513          	addi	a0,a0,-972 # 7370 <malloc+0x1432>
    3744:	00002097          	auipc	ra,0x2
    3748:	73e080e7          	jalr	1854(ra) # 5e82 <printf>
    exit(1);
    374c:	4505                	li	a0,1
    ...
    375c:	c5050513          	addi	a0,a0,-944 # 73a8 <malloc+0x146a>
    3760:	00002097          	auipc	ra,0x2
    3764:	722080e7          	jalr	1826(ra) # 5e82 <printf>
    exit(1);
    3768:	4505                	li	a0,1
    ...
    3778:	c6450513          	addi	a0,a0,-924 # 73d8 <malloc+0x149a>
    377c:	00002097          	auipc	ra,0x2
    3780:	706080e7          	jalr	1798(ra) # 5e82 <printf>
    exit(1);
    3784:	4505                	li	a0,1
    ...
    3794:	c8050513          	addi	a0,a0,-896 # 7410 <malloc+0x14d2>
    3798:	00002097          	auipc	ra,0x2
    379c:	6ea080e7          	jalr	1770(ra) # 5e82 <printf>
    exit(1);
    37a0:	4505                	li	a0,1
    ...
    37b0:	c8450513          	addi	a0,a0,-892 # 7430 <malloc+0x14f2>
    37b4:	00002097          	auipc	ra,0x2
    37b8:	6ce080e7          	jalr	1742(ra) # 5e82 <printf>
    exit(1);
    37bc:	4505                	li	a0,1
    ...
    37cc:	c9850513          	addi	a0,a0,-872 # 7460 <malloc+0x1522>
    37d0:	00002097          	auipc	ra,0x2
    37d4:	6b2080e7          	jalr	1714(ra) # 5e82 <printf>
    exit(1);
    37d8:	4505                	li	a0,1
    ...
    37e8:	ca450513          	addi	a0,a0,-860 # 7488 <malloc+0x154a>
    37ec:	00002097          	auipc	ra,0x2
    37f0:	696080e7          	jalr	1686(ra) # 5e82 <printf>
    exit(1);
    37f4:	4505                	li	a0,1
    ...
    3804:	ca850513          	addi	a0,a0,-856 # 74a8 <malloc+0x156a>
    3808:	00002097          	auipc	ra,0x2
    380c:	67a080e7          	jalr	1658(ra) # 5e82 <printf>
    exit(1);
    3810:	4505                	li	a0,1
    ...
    3820:	cb450513          	addi	a0,a0,-844 # 74d0 <malloc+0x1592>
    3824:	00002097          	auipc	ra,0x2
    3828:	65e080e7          	jalr	1630(ra) # 5e82 <printf>
    exit(1);
    382c:	4505                	li	a0,1
    ...
    383c:	cc050513          	addi	a0,a0,-832 # 74f8 <malloc+0x15ba>
    3840:	00002097          	auipc	ra,0x2
    3844:	642080e7          	jalr	1602(ra) # 5e82 <printf>
    exit(1);
    3848:	4505                	li	a0,1
    ...
    3858:	cd450513          	addi	a0,a0,-812 # 7528 <malloc+0x15ea>
    385c:	00002097          	auipc	ra,0x2
    3860:	626080e7          	jalr	1574(ra) # 5e82 <printf>
    exit(1);
    3864:	4505                	li	a0,1
    ...
    3874:	ce050513          	addi	a0,a0,-800 # 7550 <malloc+0x1612>
    3878:	00002097          	auipc	ra,0x2
    387c:	60a080e7          	jalr	1546(ra) # 5e82 <printf>
    exit(1);
    3880:	4505                	li	a0,1
    ...
    3890:	cdc50513          	addi	a0,a0,-804 # 7568 <malloc+0x162a>
    3894:	00002097          	auipc	ra,0x2
    3898:	5ee080e7          	jalr	1518(ra) # 5e82 <printf>
    exit(1);
    389c:	4505                	li	a0,1
    ...
    38ac:	ce050513          	addi	a0,a0,-800 # 7588 <malloc+0x164a>
    38b0:	00002097          	auipc	ra,0x2
    38b4:	5d2080e7          	jalr	1490(ra) # 5e82 <printf>
    exit(1);
    38b8:	4505                	li	a0,1
    ...
    38c8:	ce450513          	addi	a0,a0,-796 # 75a8 <malloc+0x166a>
    38cc:	00002097          	auipc	ra,0x2
    38d0:	5b6080e7          	jalr	1462(ra) # 5e82 <printf>
    exit(1);
    38d4:	4505                	li	a0,1
    ...
    38e4:	d0850513          	addi	a0,a0,-760 # 75e8 <malloc+0x16aa>
    38e8:	00002097          	auipc	ra,0x2
    38ec:	59a080e7          	jalr	1434(ra) # 5e82 <printf>
    exit(1);
    38f0:	4505                	li	a0,1
    ...
    3900:	d1c50513          	addi	a0,a0,-740 # 7618 <malloc+0x16da>
    3904:	00002097          	auipc	ra,0x2
    3908:	57e080e7          	jalr	1406(ra) # 5e82 <printf>
    exit(1);
    390c:	4505                	li	a0,1
    ...
    391c:	d2050513          	addi	a0,a0,-736 # 7638 <malloc+0x16fa>
    3920:	00002097          	auipc	ra,0x2
    3924:	562080e7          	jalr	1378(ra) # 5e82 <printf>
    exit(1);
    3928:	4505                	li	a0,1
    ...
    3938:	d2450513          	addi	a0,a0,-732 # 7658 <malloc+0x171a>
    393c:	00002097          	auipc	ra,0x2
    3940:	546080e7          	jalr	1350(ra) # 5e82 <printf>
    exit(1);
    3944:	4505                	li	a0,1
    ...
    3954:	d2850513          	addi	a0,a0,-728 # 7678 <malloc+0x173a>
    3958:	00002097          	auipc	ra,0x2
    395c:	52a080e7          	jalr	1322(ra) # 5e82 <printf>
    exit(1);
    3960:	4505                	li	a0,1
    ...
    3970:	d3c50513          	addi	a0,a0,-708 # 76a8 <malloc+0x176a>
    3974:	00002097          	auipc	ra,0x2
    3978:	50e080e7          	jalr	1294(ra) # 5e82 <printf>
    exit(1);
    397c:	4505                	li	a0,1
    ...
    398c:	d4850513          	addi	a0,a0,-696 # 76d0 <malloc+0x1792>
    3990:	00002097          	auipc	ra,0x2
    3994:	4f2080e7          	jalr	1266(ra) # 5e82 <printf>
    exit(1);
    3998:	4505                	li	a0,1
    ...
    39a8:	d5450513          	addi	a0,a0,-684 # 76f8 <malloc+0x17ba>
    39ac:	00002097          	auipc	ra,0x2
    39b0:	4d6080e7          	jalr	1238(ra) # 5e82 <printf>
    exit(1);
    39b4:	4505                	li	a0,1
    ...
    39c4:	d6050513          	addi	a0,a0,-672 # 7720 <malloc+0x17e2>
    39c8:	00002097          	auipc	ra,0x2
    39cc:	4ba080e7          	jalr	1210(ra) # 5e82 <printf>
    exit(1);
    39d0:	4505                	li	a0,1
    ...
    39e0:	d6450513          	addi	a0,a0,-668 # 7740 <malloc+0x1802>
    39e4:	00002097          	auipc	ra,0x2
    39e8:	49e080e7          	jalr	1182(ra) # 5e82 <printf>
    exit(1);
    39ec:	4505                	li	a0,1
    ...
    39fc:	d6850513          	addi	a0,a0,-664 # 7760 <malloc+0x1822>
    3a00:	00002097          	auipc	ra,0x2
    3a04:	482080e7          	jalr	1154(ra) # 5e82 <printf>
    exit(1);
    3a08:	4505                	li	a0,1
    ...
    3a18:	d7450513          	addi	a0,a0,-652 # 7788 <malloc+0x184a>
    3a1c:	00002097          	auipc	ra,0x2
    3a20:	466080e7          	jalr	1126(ra) # 5e82 <printf>
    exit(1);
    3a24:	4505                	li	a0,1
    ...
    3a34:	d7850513          	addi	a0,a0,-648 # 77a8 <malloc+0x186a>
    3a38:	00002097          	auipc	ra,0x2
    3a3c:	44a080e7          	jalr	1098(ra) # 5e82 <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a50:	d7c50513          	addi	a0,a0,-644 # 77c8 <malloc+0x188a>
    3a54:	00002097          	auipc	ra,0x2
    3a58:	42e080e7          	jalr	1070(ra) # 5e82 <printf>
    exit(1);
    3a5c:	4505                	li	a0,1
    ...
    3a6c:	d8850513          	addi	a0,a0,-632 # 77f0 <malloc+0x18b2>
    3a70:	00002097          	auipc	ra,0x2
    3a74:	412080e7          	jalr	1042(ra) # 5e82 <printf>
    exit(1);
    3a78:	4505                	li	a0,1
    ...
    3a88:	a0450513          	addi	a0,a0,-1532 # 7488 <malloc+0x154a>
    3a8c:	00002097          	auipc	ra,0x2
    3a90:	3f6080e7          	jalr	1014(ra) # 5e82 <printf>
    exit(1);
    3a94:	4505                	li	a0,1
    ...
    3aa4:	d7050513          	addi	a0,a0,-656 # 7810 <malloc+0x18d2>
    3aa8:	00002097          	auipc	ra,0x2
    3aac:	3da080e7          	jalr	986(ra) # 5e82 <printf>
    exit(1);
    3ab0:	4505                	li	a0,1
    ...
    3ac0:	d7450513          	addi	a0,a0,-652 # 7830 <malloc+0x18f2>
    3ac4:	00002097          	auipc	ra,0x2
    3ac8:	3be080e7          	jalr	958(ra) # 5e82 <printf>
    exit(1);
    3acc:	4505                	li	a0,1
    ...
    3adc:	d8850513          	addi	a0,a0,-632 # 7860 <malloc+0x1922>
    3ae0:	00002097          	auipc	ra,0x2
    3ae4:	3a2080e7          	jalr	930(ra) # 5e82 <printf>
    exit(1);
    3ae8:	4505                	li	a0,1
    ...
    3af8:	d8c50513          	addi	a0,a0,-628 # 7880 <malloc+0x1942>
    3afc:	00002097          	auipc	ra,0x2
    3b00:	386080e7          	jalr	902(ra) # 5e82 <printf>
    exit(1);
    3b04:	4505                	li	a0,1
...
0000000000003b0e <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3b1e:	d7e50513          	addi	a0,a0,-642 # 7898 <malloc+0x195a>
  ...
  if(unlink("..") == 0){
    ...
    3b54:	7a050513          	addi	a0,a0,1952 # 72f0 <malloc+0x13b2>
  ...
  if(chdir("/") != 0){
    ...
    3b66:	73650513          	addi	a0,a0,1846 # 7298 <malloc+0x135a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3b78:	d8c50513          	addi	a0,a0,-628 # 7900 <malloc+0x19c2>
  ...
  if(unlink("dots/..") == 0){
    ...
    3b8a:	da250513          	addi	a0,a0,-606 # 7928 <malloc+0x19ea>
  ...
  if(unlink("dots") != 0){
    ...
    3b9c:	d0050513          	addi	a0,a0,-768 # 7898 <malloc+0x195a>
    ...
    3bba:	cea50513          	addi	a0,a0,-790 # 78a0 <malloc+0x1962>
    3bbe:	00002097          	auipc	ra,0x2
    3bc2:	2c4080e7          	jalr	708(ra) # 5e82 <printf>
    exit(1);
    3bc6:	4505                	li	a0,1
    ...
    3bd6:	ce650513          	addi	a0,a0,-794 # 78b8 <malloc+0x197a>
    3bda:	00002097          	auipc	ra,0x2
    3bde:	2a8080e7          	jalr	680(ra) # 5e82 <printf>
    exit(1);
    3be2:	4505                	li	a0,1
    ...
    3bf2:	ce250513          	addi	a0,a0,-798 # 78d0 <malloc+0x1992>
    3bf6:	00002097          	auipc	ra,0x2
    3bfa:	28c080e7          	jalr	652(ra) # 5e82 <printf>
    exit(1);
    3bfe:	4505                	li	a0,1
    ...
    3c0e:	cde50513          	addi	a0,a0,-802 # 78e8 <malloc+0x19aa>
    3c12:	00002097          	auipc	ra,0x2
    3c16:	270080e7          	jalr	624(ra) # 5e82 <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	67a50513          	addi	a0,a0,1658 # 72a0 <malloc+0x1362>
    3c2e:	00002097          	auipc	ra,0x2
    3c32:	254080e7          	jalr	596(ra) # 5e82 <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c46:	cc650513          	addi	a0,a0,-826 # 7908 <malloc+0x19ca>
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	238080e7          	jalr	568(ra) # 5e82 <printf>
    exit(1);
    3c52:	4505                	li	a0,1
    ...
    3c62:	cd250513          	addi	a0,a0,-814 # 7930 <malloc+0x19f2>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	21c080e7          	jalr	540(ra) # 5e82 <printf>
    exit(1);
    3c6e:	4505                	li	a0,1
    ...
    3c7e:	cd650513          	addi	a0,a0,-810 # 7950 <malloc+0x1a12>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	200080e7          	jalr	512(ra) # 5e82 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
...
0000000000003c94 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3caa:	cca50513          	addi	a0,a0,-822 # 7970 <malloc+0x1a32>
  ...
  if(chdir("dirfile") == 0){
    ...
    3cc6:	cae50513          	addi	a0,a0,-850 # 7970 <malloc+0x1a32>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3cda:	ce250513          	addi	a0,a0,-798 # 79b8 <malloc+0x1a7a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3cf2:	cca50513          	addi	a0,a0,-822 # 79b8 <malloc+0x1a7a>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3d06:	cb650513          	addi	a0,a0,-842 # 79b8 <malloc+0x1a7a>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3d1a:	ca250513          	addi	a0,a0,-862 # 79b8 <malloc+0x1a7a>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3d2e:	c8e58593          	addi	a1,a1,-882 # 79b8 <malloc+0x1a7a>
    3d32:	00002517          	auipc	a0,0x2
    3d36:	4e650513          	addi	a0,a0,1254 # 6218 <malloc+0x2da>
  ...
  if(unlink("dirfile") != 0){
    ...
    3d4a:	c2a50513          	addi	a0,a0,-982 # 7970 <malloc+0x1a32>
  ...
  fd = open(".", O_RDWR);
    ...
    3d60:	9cc50513          	addi	a0,a0,-1588 # 6728 <malloc+0x7ea>
  ...
  fd = open(".", 0);
    ...
    3d76:	9b650513          	addi	a0,a0,-1610 # 6728 <malloc+0x7ea>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3d8a:	35a58593          	addi	a1,a1,858 # 60e0 <malloc+0x1a2>
  ...
  close(fd);
    ...
    3db6:	bc650513          	addi	a0,a0,-1082 # 7978 <malloc+0x1a3a>
    3dba:	00002097          	auipc	ra,0x2
    3dbe:	0c8080e7          	jalr	200(ra) # 5e82 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
    ...
    3dd2:	bca50513          	addi	a0,a0,-1078 # 7998 <malloc+0x1a5a>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	0ac080e7          	jalr	172(ra) # 5e82 <printf>
    exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	bde50513          	addi	a0,a0,-1058 # 79c8 <malloc+0x1a8a>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	090080e7          	jalr	144(ra) # 5e82 <printf>
    exit(1);
    3dfa:	4505                	li	a0,1
    ...
    3e0a:	bc250513          	addi	a0,a0,-1086 # 79c8 <malloc+0x1a8a>
    3e0e:	00002097          	auipc	ra,0x2
    3e12:	074080e7          	jalr	116(ra) # 5e82 <printf>
    exit(1);
    3e16:	4505                	li	a0,1
    ...
    3e26:	bce50513          	addi	a0,a0,-1074 # 79f0 <malloc+0x1ab2>
    3e2a:	00002097          	auipc	ra,0x2
    3e2e:	058080e7          	jalr	88(ra) # 5e82 <printf>
    exit(1);
    3e32:	4505                	li	a0,1
    ...
    3e42:	bda50513          	addi	a0,a0,-1062 # 7a18 <malloc+0x1ada>
    3e46:	00002097          	auipc	ra,0x2
    3e4a:	03c080e7          	jalr	60(ra) # 5e82 <printf>
    exit(1);
    3e4e:	4505                	li	a0,1
    ...
    3e5e:	be650513          	addi	a0,a0,-1050 # 7a40 <malloc+0x1b02>
    3e62:	00002097          	auipc	ra,0x2
    3e66:	020080e7          	jalr	32(ra) # 5e82 <printf>
    exit(1);
    3e6a:	4505                	li	a0,1
    ...
    3e7a:	bf250513          	addi	a0,a0,-1038 # 7a68 <malloc+0x1b2a>
    3e7e:	00002097          	auipc	ra,0x2
    3e82:	004080e7          	jalr	4(ra) # 5e82 <printf>
    exit(1);
    3e86:	4505                	li	a0,1
    ...
    3e96:	bf650513          	addi	a0,a0,-1034 # 7a88 <malloc+0x1b4a>
    3e9a:	00002097          	auipc	ra,0x2
    3e9e:	fe8080e7          	jalr	-24(ra) # 5e82 <printf>
    exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb2:	c0250513          	addi	a0,a0,-1022 # 7ab0 <malloc+0x1b72>
    3eb6:	00002097          	auipc	ra,0x2
    3eba:	fcc080e7          	jalr	-52(ra) # 5e82 <printf>
    exit(1);
    3ebe:	4505                	li	a0,1
...
0000000000003ec8 <iref>:
{
    ...
    3ee8:	be4a8a93          	addi	s5,s5,-1052 # 7ac8 <malloc+0x1b8a>
    mkdir("");
    3eec:	00003497          	auipc	s1,0x3
    3ef0:	6e448493          	addi	s1,s1,1764 # 75d0 <malloc+0x1692>
    link("README", "");
    3ef4:	00002b17          	auipc	s6,0x2
    3ef8:	324b0b13          	addi	s6,s6,804 # 6218 <malloc+0x2da>
    fd = open("", O_CREATE);
    3efc:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    3f00:	00004997          	auipc	s3,0x4
    3f04:	ac098993          	addi	s3,s3,-1344 # 79c0 <malloc+0x1a82>
    3f08:	a891                	j	3f5c <iref+0x94>
      printf("%s: mkdir irefd failed\n", s);
    3f0a:	85de                	mv	a1,s7
    3f0c:	00004517          	auipc	a0,0x4
    3f10:	bc450513          	addi	a0,a0,-1084 # 7ad0 <malloc+0x1b92>
    3f14:	00002097          	auipc	ra,0x2
    3f18:	f6e080e7          	jalr	-146(ra) # 5e82 <printf>
      exit(1);
    3f1c:	4505                	li	a0,1
    ...
    3f2c:	bc050513          	addi	a0,a0,-1088 # 7ae8 <malloc+0x1baa>
    3f30:	00002097          	auipc	ra,0x2
    3f34:	f52080e7          	jalr	-174(ra) # 5e82 <printf>
      exit(1);
    3f38:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3fbc:	33898993          	addi	s3,s3,824 # 72f0 <malloc+0x13b2>
    unlink("irefd");
    3fc0:	00004917          	auipc	s2,0x4
    3fc4:	b0890913          	addi	s2,s2,-1272 # 7ac8 <malloc+0x1b8a>
    chdir("..");
    3fc8:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3fe4:	2b850513          	addi	a0,a0,696 # 7298 <malloc+0x135a>
...
0000000000004006 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4016:	aee50513          	addi	a0,a0,-1298 # 7b00 <malloc+0x1bc2>
  ...
  if(pid == 0){
    ...
    403a:	aca50513          	addi	a0,a0,-1334 # 7b00 <malloc+0x1bc2>
    ...
    4050:	ad450513          	addi	a0,a0,-1324 # 7b20 <malloc+0x1be2>
    4054:	00002097          	auipc	ra,0x2
    4058:	e2e080e7          	jalr	-466(ra) # 5e82 <printf>
      exit(1);
    405c:	4505                	li	a0,1
    ...
    406c:	aa050513          	addi	a0,a0,-1376 # 7b08 <malloc+0x1bca>
    4070:	00002097          	auipc	ra,0x2
    4074:	e12080e7          	jalr	-494(ra) # 5e82 <printf>
    exit(1);
    4078:	4505                	li	a0,1
    ...
    4088:	84450513          	addi	a0,a0,-1980 # 68c8 <malloc+0x98a>
    408c:	00002097          	auipc	ra,0x2
    4090:	df6080e7          	jalr	-522(ra) # 5e82 <printf>
    exit(1);
    4094:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    40b6:	a4e50513          	addi	a0,a0,-1458 # 7b00 <malloc+0x1bc2>
    ...
    40ca:	9f250513          	addi	a0,a0,-1550 # 6ab8 <malloc+0xb7a>
    40ce:	00002097          	auipc	ra,0x2
    40d2:	db4080e7          	jalr	-588(ra) # 5e82 <printf>
    exit(1);
    40d6:	4505                	li	a0,1
...
00000000000040f8 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4108:	a4450513          	addi	a0,a0,-1468 # 7b48 <malloc+0x1c0a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4134:	a1850513          	addi	a0,a0,-1512 # 7b48 <malloc+0x1c0a>
  ...
  sleep(10); // one second
    ...
    416c:	92050513          	addi	a0,a0,-1760 # 6a88 <malloc+0xb4a>
    4170:	00002097          	auipc	ra,0x2
    4174:	d12080e7          	jalr	-750(ra) # 5e82 <printf>
    exit(1);
    4178:	4505                	li	a0,1
    ...
    4186:	9c648493          	addi	s1,s1,-1594 # 7b48 <malloc+0x1c0a>
    418a:	4581                	li	a1,0
    418c:	8526                	mv	a0,s1
    ...
    41ae:	99e50513          	addi	a0,a0,-1634 # 7b48 <malloc+0x1c0a>
...
00000000000041ce <killstatus>:
{
  ...
  exit(0);
    ...
    423c:	69050513          	addi	a0,a0,1680 # 68c8 <malloc+0x98a>
    4240:	00002097          	auipc	ra,0x2
    4244:	c42080e7          	jalr	-958(ra) # 5e82 <printf>
      exit(1);
    4248:	4505                	li	a0,1
    ...
    4262:	8fa50513          	addi	a0,a0,-1798 # 7b58 <malloc+0x1c1a>
    4266:	00002097          	auipc	ra,0x2
    426a:	c1c080e7          	jalr	-996(ra) # 5e82 <printf>
       exit(1);
    426e:	4505                	li	a0,1
...
0000000000004278 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    42a2:	7ea50513          	addi	a0,a0,2026 # 6a88 <malloc+0xb4a>
    42a6:	00002097          	auipc	ra,0x2
    42aa:	bdc080e7          	jalr	-1060(ra) # 5e82 <printf>
    exit(1);
    42ae:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    42d0:	5fc50513          	addi	a0,a0,1532 # 68c8 <malloc+0x98a>
    42d4:	00002097          	auipc	ra,0x2
    42d8:	bae080e7          	jalr	-1106(ra) # 5e82 <printf>
    exit(1);
    42dc:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4314:	dd058593          	addi	a1,a1,-560 # 60e0 <malloc+0x1a2>
    ...
    433e:	58e50513          	addi	a0,a0,1422 # 68c8 <malloc+0x98a>
    4342:	00002097          	auipc	ra,0x2
    4346:	b40080e7          	jalr	-1216(ra) # 5e82 <printf>
     exit(1);
    434a:	4505                	li	a0,1
    ...
    435a:	82250513          	addi	a0,a0,-2014 # 7b78 <malloc+0x1c3a>
    435e:	00002097          	auipc	ra,0x2
    4362:	b24080e7          	jalr	-1244(ra) # 5e82 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4376:	00009597          	auipc	a1,0x9
    437a:	0fa58593          	addi	a1,a1,250 # d470 <buf>
    ...
    4396:	7fe50513          	addi	a0,a0,2046 # 7b90 <malloc+0x1c52>
    439a:	00002097          	auipc	ra,0x2
    439e:	ae8080e7          	jalr	-1304(ra) # 5e82 <printf>
}
  ...
  printf("kill... ");
    ...
    43c2:	7ea50513          	addi	a0,a0,2026 # 7ba8 <malloc+0x1c6a>
    43c6:	00002097          	auipc	ra,0x2
    43ca:	abc080e7          	jalr	-1348(ra) # 5e82 <printf>
  kill(pid1);
    43ce:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    43f0:	7cc50513          	addi	a0,a0,1996 # 7bb8 <malloc+0x1c7a>
    43f4:	00002097          	auipc	ra,0x2
    43f8:	a8e080e7          	jalr	-1394(ra) # 5e82 <printf>
  wait(0);
    43fc:	4501                	li	a0,0
...
000000000000441c <reparent>:
{
  ...
  exit(0);
    ...
    4470:	45c50513          	addi	a0,a0,1116 # 68c8 <malloc+0x98a>
    4474:	00002097          	auipc	ra,0x2
    4478:	a0e080e7          	jalr	-1522(ra) # 5e82 <printf>
      exit(1);
    447c:	4505                	li	a0,1
    ...
    448c:	5c850513          	addi	a0,a0,1480 # 6a50 <malloc+0xb12>
    4490:	00002097          	auipc	ra,0x2
    4494:	9f2080e7          	jalr	-1550(ra) # 5e82 <printf>
        exit(1);
    4498:	4505                	li	a0,1
...
00000000000044cc <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    450c:	4c850513          	addi	a0,a0,1224 # 69d0 <malloc+0xa92>
    4510:	00002097          	auipc	ra,0x2
    4514:	972080e7          	jalr	-1678(ra) # 5e82 <printf>
    exit(1);
    4518:	4505                	li	a0,1
    ...
    4540:	ba458593          	addi	a1,a1,-1116 # 60e0 <malloc+0x1a2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4608:	5c450513          	addi	a0,a0,1476 # 7bc8 <malloc+0x1c8a>
    460c:	00002097          	auipc	ra,0x2
    4610:	876080e7          	jalr	-1930(ra) # 5e82 <printf>
    exit(1);
    4614:	4505                	li	a0,1
    ...
    4624:	2a850513          	addi	a0,a0,680 # 68c8 <malloc+0x98a>
    4628:	00002097          	auipc	ra,0x2
    462c:	85a080e7          	jalr	-1958(ra) # 5e82 <printf>
    exit(1);
    4630:	4505                	li	a0,1
    ...
    465a:	6705                	lui	a4,0x1
      n += *(a+i);
    465c:	0007c603          	lbu	a2,0(a5) # 6400000 <__BSS_END__+0x63efb80>
    ...
    4670:	57c50513          	addi	a0,a0,1404 # 7be8 <malloc+0x1caa>
    4674:	00002097          	auipc	ra,0x2
    4678:	80e080e7          	jalr	-2034(ra) # 5e82 <printf>
    exit(1);
    467c:	4505                	li	a0,1
...
0000000000004690 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    46da:	868080e7          	jalr	-1944(ra) # 5f3e <malloc>
    ...
    4714:	50850513          	addi	a0,a0,1288 # 7c18 <malloc+0x1cda>
    4718:	00001097          	auipc	ra,0x1
    471c:	76a080e7          	jalr	1898(ra) # 5e82 <printf>
      exit(1);
    4720:	4505                	li	a0,1
...
0000000000004734 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    47e0:	46c50513          	addi	a0,a0,1132 # 7c48 <malloc+0x1d0a>
    47e4:	00001097          	auipc	ra,0x1
    47e8:	69e080e7          	jalr	1694(ra) # 5e82 <printf>
    exit(1);
    47ec:	4505                	li	a0,1
    ...
    4802:	47250513          	addi	a0,a0,1138 # 7c70 <malloc+0x1d32>
    4806:	00001097          	auipc	ra,0x1
    480a:	67c080e7          	jalr	1660(ra) # 5e82 <printf>
      exit(1);
    480e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    484e:	3ee50513          	addi	a0,a0,1006 # 7c38 <malloc+0x1cfa>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    489a:	3fa50513          	addi	a0,a0,1018 # 7c90 <malloc+0x1d52>
    489e:	00001097          	auipc	ra,0x1
    48a2:	5e4080e7          	jalr	1508(ra) # 5e82 <printf>
    exit(1);
    48a6:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    48d6:	36650513          	addi	a0,a0,870 # 7c38 <malloc+0x1cfa>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    48fc:	3c050513          	addi	a0,a0,960 # 7cb8 <malloc+0x1d7a>
    4900:	00001097          	auipc	ra,0x1
    4904:	582080e7          	jalr	1410(ra) # 5e82 <printf>
    exit(1);
    4908:	4505                	li	a0,1
...
000000000000491c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4940:	39478793          	addi	a5,a5,916 # 7cd0 <malloc+0x1d92>
    4944:	f6f43823          	sd	a5,-144(s0)
    4948:	00003797          	auipc	a5,0x3
    494c:	39078793          	addi	a5,a5,912 # 7cd8 <malloc+0x1d9a>
    4950:	f6f43c23          	sd	a5,-136(s0)
    4954:	00003797          	auipc	a5,0x3
    4958:	38c78793          	addi	a5,a5,908 # 7ce0 <malloc+0x1da2>
    495c:	f8f43023          	sd	a5,-128(s0)
    4960:	00003797          	auipc	a5,0x3
    4964:	38878793          	addi	a5,a5,904 # 7ce8 <malloc+0x1daa>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    49bc:	00009a17          	auipc	s4,0x9
    49c0:	ab4a0a13          	addi	s4,s4,-1356 # d470 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49d6:	31650513          	addi	a0,a0,790 # 6ce8 <malloc+0xdaa>
    49da:	00001097          	auipc	ra,0x1
    49de:	4a8080e7          	jalr	1192(ra) # 5e82 <printf>
      exit(1);
    49e2:	4505                	li	a0,1
    ...
    4a08:	00009517          	auipc	a0,0x9
    4a0c:	a6850513          	addi	a0,a0,-1432 # d470 <buf>
    4a10:	00001097          	auipc	ra,0x1
    4a14:	ef2080e7          	jalr	-270(ra) # 5902 <memset>
    4a18:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    4a1a:	1f400993          	li	s3,500
    4a1e:	00009a17          	auipc	s4,0x9
    4a22:	a52a0a13          	addi	s4,s4,-1454 # d470 <buf>
    4a26:	864e                	mv	a2,s3
    4a28:	85d2                	mv	a1,s4
    4a2a:	854a                	mv	a0,s2
    ...
    4a4e:	2a650513          	addi	a0,a0,678 # 7cf0 <malloc+0x1db2>
    4a52:	00001097          	auipc	ra,0x1
    4a56:	430080e7          	jalr	1072(ra) # 5e82 <printf>
        exit(1);
    4a5a:	4505                	li	a0,1
    ...
    4a68:	29c50513          	addi	a0,a0,668 # 7d00 <malloc+0x1dc2>
    4a6c:	00001097          	auipc	ra,0x1
    4a70:	416080e7          	jalr	1046(ra) # 5e82 <printf>
          exit(1);
    4a74:	4505                	li	a0,1
    ...
    4a8e:	28e50513          	addi	a0,a0,654 # 7d18 <malloc+0x1dda>
    4a92:	00001097          	auipc	ra,0x1
    4a96:	3f0080e7          	jalr	1008(ra) # 5e82 <printf>
          exit(1);
    4a9a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4aea:	00009797          	auipc	a5,0x9
    4aee:	98678793          	addi	a5,a5,-1658 # d470 <buf>
    ...
    4b10:	21c50513          	addi	a0,a0,540 # 7d28 <malloc+0x1dea>
    4b14:	00001097          	auipc	ra,0x1
    4b18:	36e080e7          	jalr	878(ra) # 5e82 <printf>
      exit(1);
    4b1c:	4505                	li	a0,1
...
0000000000004b44 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b78:	556b0b13          	addi	s6,s6,1366 # 55555556 <__BSS_END__+0x555450d6>
    4b7c:	4c05                	li	s8,1
      fd = open(file, O_CREATE | O_RDWR);
    4b7e:	20200c93          	li	s9,514
      link("C0", file);
    4b82:	00003d17          	auipc	s10,0x3
    4b86:	1bed0d13          	addi	s10,s10,446 # 7d40 <malloc+0x1e02>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    4ba6:	66778793          	addi	a5,a5,1639 # 66666667 <__BSS_END__+0x666561e7>
    ...
    4be2:	16a50513          	addi	a0,a0,362 # 7d48 <malloc+0x1e0a>
    4be6:	00001097          	auipc	ra,0x1
    4bea:	29c080e7          	jalr	668(ra) # 5e82 <printf>
        exit(1);
    4bee:	4505                	li	a0,1
    ...
    4c00:	14450513          	addi	a0,a0,324 # 7d40 <malloc+0x1e02>
  ...
  fd = open(".", 0);
    ...
    4c38:	af450513          	addi	a0,a0,-1292 # 6728 <malloc+0x7ea>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4cae:	0be50513          	addi	a0,a0,190 # 7d68 <malloc+0x1e2a>
    4cb2:	00001097          	auipc	ra,0x1
    4cb6:	1d0080e7          	jalr	464(ra) # 5e82 <printf>
        exit(1);
    4cba:	4505                	li	a0,1
    ...
    4cce:	0be50513          	addi	a0,a0,190 # 7d88 <malloc+0x1e4a>
    4cd2:	00001097          	auipc	ra,0x1
    4cd6:	1b0080e7          	jalr	432(ra) # 5e82 <printf>
        exit(1);
    4cda:	4505                	li	a0,1
  ...
  if(n != N){
    ...
    4cfa:	556a0a13          	addi	s4,s4,1366 # 55555556 <__BSS_END__+0x555450d6>
      close(open(file, 0));
  ...
  for(i = 0; i < N; i++){
    ...
    4d0e:	0a650513          	addi	a0,a0,166 # 7db0 <malloc+0x1e72>
    4d12:	00001097          	auipc	ra,0x1
    4d16:	170080e7          	jalr	368(ra) # 5e82 <printf>
    exit(1);
    4d1a:	4505                	li	a0,1
    ...
    4d2a:	ba250513          	addi	a0,a0,-1118 # 68c8 <malloc+0x98a>
    4d2e:	00001097          	auipc	ra,0x1
    4d32:	154080e7          	jalr	340(ra) # 5e82 <printf>
      exit(1);
    4d36:	4505                	li	a0,1
...
0000000000004ede <bigfile>:
{
  ...
  if(fd < 0){
    ...
    4f24:	00008997          	auipc	s3,0x8
    4f28:	54c98993          	addi	s3,s3,1356 # d470 <buf>
  for(i = 0; i < N; i++){
    4f2c:	4ad1                	li	s5,20
    memset(buf, i, SZ);
    4f2e:	864a                	mv	a2,s2
  ...
  fd = open("bigfile.dat", 0);
    ...
    4f64:	e8850513          	addi	a0,a0,-376 # 7de8 <malloc+0x1eaa>
  ...
  for(i = 0; ; i++){
    ...
    4f7a:	00008917          	auipc	s2,0x8
    4f7e:	4f690913          	addi	s2,s2,1270 # d470 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4fc6:	e3650513          	addi	a0,a0,-458 # 7df8 <malloc+0x1eba>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	eb8080e7          	jalr	-328(ra) # 5e82 <printf>
    exit(1);
    4fd2:	4505                	li	a0,1
    ...
    4fe2:	e3a50513          	addi	a0,a0,-454 # 7e18 <malloc+0x1eda>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	e9c080e7          	jalr	-356(ra) # 5e82 <printf>
      exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	e3e50513          	addi	a0,a0,-450 # 7e38 <malloc+0x1efa>
    5002:	00001097          	auipc	ra,0x1
    5006:	e80080e7          	jalr	-384(ra) # 5e82 <printf>
    exit(1);
    500a:	4505                	li	a0,1
    ...
    501a:	e4250513          	addi	a0,a0,-446 # 7e58 <malloc+0x1f1a>
    501e:	00001097          	auipc	ra,0x1
    5022:	e64080e7          	jalr	-412(ra) # 5e82 <printf>
      exit(1);
    5026:	4505                	li	a0,1
    ...
    5036:	e4650513          	addi	a0,a0,-442 # 7e78 <malloc+0x1f3a>
    503a:	00001097          	auipc	ra,0x1
    503e:	e48080e7          	jalr	-440(ra) # 5e82 <printf>
      exit(1);
    5042:	4505                	li	a0,1
    ...
    5052:	e4250513          	addi	a0,a0,-446 # 7e90 <malloc+0x1f52>
    5056:	00001097          	auipc	ra,0x1
    505a:	e2c080e7          	jalr	-468(ra) # 5e82 <printf>
      exit(1);
    505e:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5080:	d6c50513          	addi	a0,a0,-660 # 7de8 <malloc+0x1eaa>
    ...
    50a6:	e0e50513          	addi	a0,a0,-498 # 7eb0 <malloc+0x1f72>
    50aa:	00001097          	auipc	ra,0x1
    50ae:	dd8080e7          	jalr	-552(ra) # 5e82 <printf>
    exit(1);
    50b2:	4505                	li	a0,1
...
00000000000050bc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    50de:	df650513          	addi	a0,a0,-522 # 7ed0 <malloc+0x1f92>
    50e2:	00001097          	auipc	ra,0x1
    50e6:	da0080e7          	jalr	-608(ra) # 5e82 <printf>
  for(nfiles = 0; ; nfiles++){
    50ea:	4481                	li	s1,0
    name[0] = 'f';
    ...
    50f4:	dd3c8c93          	addi	s9,s9,-557 # 10624dd3 <__BSS_END__+0x10614953>
    name[2] = '0' + (nfiles % 1000) / 100;
    50f8:	51eb8ab7          	lui	s5,0x51eb8
    50fc:	51fa8a93          	addi	s5,s5,1311 # 51eb851f <__BSS_END__+0x51ea809f>
    name[3] = '0' + (nfiles % 100) / 10;
    5100:	66666a37          	lui	s4,0x66666
    5104:	667a0a13          	addi	s4,s4,1639 # 66666667 <__BSS_END__+0x666561e7>
    printf("writing %s\n", name);
    ...
    5198:	d4c50513          	addi	a0,a0,-692 # 7ee0 <malloc+0x1fa2>
    519c:	00001097          	auipc	ra,0x1
    51a0:	ce6080e7          	jalr	-794(ra) # 5e82 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    51c0:	d3450513          	addi	a0,a0,-716 # 7ef0 <malloc+0x1fb2>
    51c4:	00001097          	auipc	ra,0x1
    51c8:	cbe080e7          	jalr	-834(ra) # 5e82 <printf>
    name[0] = 'f';
    51cc:	06600c13          	li	s8,102
    name[1] = '0' + nfiles / 1000;
    51d0:	10625a37          	lui	s4,0x10625
    51d4:	dd3a0a13          	addi	s4,s4,-557 # 10624dd3 <__BSS_END__+0x10614953>
    name[2] = '0' + (nfiles % 1000) / 100;
    51d8:	3e800b93          	li	s7,1000
    51dc:	51eb89b7          	lui	s3,0x51eb8
    51e0:	51f98993          	addi	s3,s3,1311 # 51eb851f <__BSS_END__+0x51ea809f>
    name[3] = '0' + (nfiles % 100) / 10;
    51e4:	06400b13          	li	s6,100
    51e8:	66666937          	lui	s2,0x66666
    51ec:	66790913          	addi	s2,s2,1639 # 66666667 <__BSS_END__+0x666561e7>
    unlink(name);
  ...
  printf("fsfull test finished\n");
    ...
    5286:	c8e50513          	addi	a0,a0,-882 # 7f10 <malloc+0x1fd2>
    528a:	00001097          	auipc	ra,0x1
    528e:	bf8080e7          	jalr	-1032(ra) # 5e82 <printf>
}
    ...
    52b6:	00008b97          	auipc	s7,0x8
    52ba:	1bab8b93          	addi	s7,s7,442 # d470 <buf>
      if(cc < BSIZE)
    ...
    52e0:	c2450513          	addi	a0,a0,-988 # 7f00 <malloc+0x1fc2>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	b9e080e7          	jalr	-1122(ra) # 5e82 <printf>
    close(fd);
    52ec:	854a                	mv	a0,s2
...
00000000000052fe <badwrite>:
{
  ...
  unlink("junk");
    ...
    5316:	c1650513          	addi	a0,a0,-1002 # 7f28 <malloc+0x1fea>
    ...
    532e:	bfe98993          	addi	s3,s3,-1026 # 7f28 <malloc+0x1fea>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    537a:	bb250513          	addi	a0,a0,-1102 # 7f28 <malloc+0x1fea>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5392:	d5258593          	addi	a1,a1,-686 # 60e0 <malloc+0x1a2>
    ...
    53a8:	ba450513          	addi	a0,a0,-1116 # 7f48 <malloc+0x200a>
    53ac:	00001097          	auipc	ra,0x1
    53b0:	ad6080e7          	jalr	-1322(ra) # 5e82 <printf>
    exit(1);
    53b4:	4505                	li	a0,1
    ...
    53c2:	b7250513          	addi	a0,a0,-1166 # 7f30 <malloc+0x1ff2>
    53c6:	00001097          	auipc	ra,0x1
    53ca:	abc080e7          	jalr	-1348(ra) # 5e82 <printf>
      exit(1);
    53ce:	4505                	li	a0,1
    ...
    53dc:	b5850513          	addi	a0,a0,-1192 # 7f30 <malloc+0x1ff2>
    53e0:	00001097          	auipc	ra,0x1
    53e4:	aa2080e7          	jalr	-1374(ra) # 5e82 <printf>
    exit(1);
    53e8:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    5400:	b2c50513          	addi	a0,a0,-1236 # 7f28 <malloc+0x1fea>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    545a:	c8aa0a13          	addi	s4,s4,-886 # 60e0 <malloc+0x1a2>
      uint64 a = (uint64) sbrk(4096);
    545e:	854a                	mv	a0,s2
    ...
    548a:	b1250513          	addi	a0,a0,-1262 # 7f98 <malloc+0x205a>
    548e:	00001097          	auipc	ra,0x1
    5492:	9f4080e7          	jalr	-1548(ra) # 5e82 <printf>
        exit(1);
    5496:	4505                	li	a0,1
    ...
    54ac:	ab050513          	addi	a0,a0,-1360 # 7f58 <malloc+0x201a>
    54b0:	00001097          	auipc	ra,0x1
    54b4:	9d2080e7          	jalr	-1582(ra) # 5e82 <printf>
    exit(1);
    54b8:	4505                	li	a0,1
    ...
    54ce:	aae50513          	addi	a0,a0,-1362 # 7f78 <malloc+0x203a>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	9b0080e7          	jalr	-1616(ra) # 5e82 <printf>
    exit(1);
    54da:	4505                	li	a0,1
  ...
  while(1){
    ...
    5528:	a9450513          	addi	a0,a0,-1388 # 7fb8 <malloc+0x207a>
    552c:	00001097          	auipc	ra,0x1
    5530:	956080e7          	jalr	-1706(ra) # 5e82 <printf>
      exit(1);
    5534:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5578:	a6450513          	addi	a0,a0,-1436 # 7fd8 <malloc+0x209a>
    557c:	00001097          	auipc	ra,0x1
    5580:	906080e7          	jalr	-1786(ra) # 5e82 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55a8:	a5c50513          	addi	a0,a0,-1444 # 8000 <malloc+0x20c2>
    55ac:	00001097          	auipc	ra,0x1
    55b0:	8d6080e7          	jalr	-1834(ra) # 5e82 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55cc:	a2050513          	addi	a0,a0,-1504 # 7fe8 <malloc+0x20aa>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	8b2080e7          	jalr	-1870(ra) # 5e82 <printf>
    exit(1);
    55d8:	4505                	li	a0,1
    ...
    55f4:	a1850513          	addi	a0,a0,-1512 # 8008 <malloc+0x20ca>
    55f8:	00001097          	auipc	ra,0x1
    55fc:	88a080e7          	jalr	-1910(ra) # 5e82 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    563e:	dee78793          	addi	a5,a5,-530 # 8428 <malloc+0x24ea>
    5642:	bd040713          	addi	a4,s0,-1072
    5646:	00003697          	auipc	a3,0x3
    564a:	1d268693          	addi	a3,a3,466 # 8818 <malloc+0x28da>
  ...
  printf("usertests starting\n");
    ...
    5682:	a4a50513          	addi	a0,a0,-1462 # 80c8 <malloc+0x218a>
    5686:	00000097          	auipc	ra,0x0
    568a:	7fc080e7          	jalr	2044(ra) # 5e82 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    56ba:	9ca50513          	addi	a0,a0,-1590 # 8080 <malloc+0x2142>
    56be:	00000097          	auipc	ra,0x0
    56c2:	7c4080e7          	jalr	1988(ra) # 5e82 <printf>
    exit(1);
    56c6:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    56e6:	92e58593          	addi	a1,a1,-1746 # 8010 <malloc+0x20d2>
    ...
    56fc:	d3078793          	addi	a5,a5,-720 # 8428 <malloc+0x24ea>
    5700:	bd040713          	addi	a4,s0,-1072
    5704:	00003697          	auipc	a3,0x3
    5708:	11468693          	addi	a3,a3,276 # 8818 <malloc+0x28da>
    ...
    5740:	9a450513          	addi	a0,a0,-1628 # 80e0 <malloc+0x21a2>
    5744:	00000097          	auipc	ra,0x0
    5748:	73e080e7          	jalr	1854(ra) # 5e82 <printf>
        printf("SOME TESTS FAILED\n");
    574c:	00003a97          	auipc	s5,0x3
    5750:	91ca8a93          	addi	s5,s5,-1764 # 8068 <malloc+0x212a>
        if(continuous != 2)
    5754:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5756:	00003b17          	auipc	s6,0x3
    575a:	8f2b0b13          	addi	s6,s6,-1806 # 8048 <malloc+0x210a>
    575e:	a8fd                	j	585c <main+0x25a>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5760:	00003597          	auipc	a1,0x3
    5764:	8b858593          	addi	a1,a1,-1864 # 8018 <malloc+0x20da>
    ...
    579a:	88a50513          	addi	a0,a0,-1910 # 8020 <malloc+0x20e2>
    579e:	00000097          	auipc	ra,0x0
    57a2:	6e4080e7          	jalr	1764(ra) # 5e82 <printf>
    exit(1);
    57a6:	4505                	li	a0,1
    ...
    57c4:	6c2080e7          	jalr	1730(ra) # 5e82 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5812:	85a50513          	addi	a0,a0,-1958 # 8068 <malloc+0x212a>
    5816:	00000097          	auipc	ra,0x0
    581a:	66c080e7          	jalr	1644(ra) # 5e82 <printf>
    exit(1);
    581e:	4505                	li	a0,1
    ...
    582c:	88850513          	addi	a0,a0,-1912 # 80b0 <malloc+0x2172>
    5830:	00000097          	auipc	ra,0x0
    5834:	652080e7          	jalr	1618(ra) # 5e82 <printf>
    exit(0);
    5838:	4501                	li	a0,0
    ...
    5848:	63e080e7          	jalr	1598(ra) # 5e82 <printf>
        if(continuous != 2)
...
putc(int fd, char c)
{
    5bcc:	1101                	addi	sp,sp,-32
    5bce:	ec06                	sd	ra,24(sp)
    5bd0:	e822                	sd	s0,16(sp)
    5bd2:	1000                	addi	s0,sp,32
    5bd4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5bd8:	4605                	li	a2,1
    5bda:	fef40593          	addi	a1,s0,-17
    5bde:	00000097          	auipc	ra,0x0
    5be2:	f66080e7          	jalr	-154(ra) # 5b44 <write>
}
    5be6:	60e2                	ld	ra,24(sp)
    5be8:	6442                	ld	s0,16(sp)
    5bea:	6105                	addi	sp,sp,32
    5bec:	8082                	ret

0000000000005bee <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5bee:	7139                	addi	sp,sp,-64
    5bf0:	fc06                	sd	ra,56(sp)
    5bf2:	f822                	sd	s0,48(sp)
    5bf4:	f426                	sd	s1,40(sp)
    5bf6:	f04a                	sd	s2,32(sp)
    5bf8:	ec4e                	sd	s3,24(sp)
    5bfa:	0080                	addi	s0,sp,64
    5bfc:	892a                	mv	s2,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5bfe:	c299                	beqz	a3,5c04 <printint+0x16>
    5c00:	0805c063          	bltz	a1,5c80 <printint+0x92>
  neg = 0;
    5c04:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
    5c0e:	00003817          	auipc	a6,0x3
    5c12:	c6280813          	addi	a6,a6,-926 # 8870 <digits>
    5c16:	88be                	mv	a7,a5
    5c18:	0017851b          	addiw	a0,a5,1
    5c1c:	87aa                	mv	a5,a0
    5c1e:	02c5f73b          	remuw	a4,a1,a2
    5c22:	1702                	slli	a4,a4,0x20
    5c24:	9301                	srli	a4,a4,0x20
    5c26:	9742                	add	a4,a4,a6
    5c28:	00074703          	lbu	a4,0(a4)
    5c2c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    5c30:	872e                	mv	a4,a1
    5c32:	02c5d5bb          	divuw	a1,a1,a2
    5c36:	0685                	addi	a3,a3,1
    5c38:	fcc77fe3          	bgeu	a4,a2,5c16 <printint+0x28>
  if(neg)
    5c3c:	000e0c63          	beqz	t3,5c54 <printint+0x66>
    buf[i++] = '-';
    5c40:	fd050793          	addi	a5,a0,-48
    5c44:	00878533          	add	a0,a5,s0
    5c48:	02d00793          	li	a5,45
    5c4c:	fef50823          	sb	a5,-16(a0)
    5c50:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
    5c54:	fff7899b          	addiw	s3,a5,-1
    5c58:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
    5c5c:	fff4c583          	lbu	a1,-1(s1)
    5c60:	854a                	mv	a0,s2
    5c62:	00000097          	auipc	ra,0x0
    5c66:	f6a080e7          	jalr	-150(ra) # 5bcc <putc>
  while(--i >= 0)
    5c6a:	39fd                	addiw	s3,s3,-1
    5c6c:	14fd                	addi	s1,s1,-1
    5c6e:	fe09d7e3          	bgez	s3,5c5c <printint+0x6e>
}
    5c72:	70e2                	ld	ra,56(sp)
    5c74:	7442                	ld	s0,48(sp)
    5c76:	74a2                	ld	s1,40(sp)
    5c78:	7902                	ld	s2,32(sp)
    5c7a:	69e2                	ld	s3,24(sp)
    5c7c:	6121                	addi	sp,sp,64
    5c7e:	8082                	ret
    x = -xx;
    5c80:	40b005bb          	negw	a1,a1
    neg = 1;
    5c84:	4e05                	li	t3,1
    x = -xx;
    5c86:	b741                	j	5c06 <printint+0x18>

0000000000005c88 <vprintf>:
}
...
{
    5c88:	715d                	addi	sp,sp,-80
    5c8a:	e486                	sd	ra,72(sp)
    5c8c:	e0a2                	sd	s0,64(sp)
    5c8e:	f84a                	sd	s2,48(sp)
    5c90:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5c92:	0005c903          	lbu	s2,0(a1)
    5c96:	1a090a63          	beqz	s2,5e4a <vprintf+0x1c2>
    5c9a:	fc26                	sd	s1,56(sp)
    5c9c:	f44e                	sd	s3,40(sp)
    5c9e:	f052                	sd	s4,32(sp)
    5ca0:	ec56                	sd	s5,24(sp)
    5ca2:	e85a                	sd	s6,16(sp)
    5ca4:	e45e                	sd	s7,8(sp)
    5ca6:	8aaa                	mv	s5,a0
    5ca8:	8bb2                	mv	s7,a2
    5caa:	00158493          	addi	s1,a1,1
  state = 0;
    5cae:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5cb0:	02500a13          	li	s4,37
    5cb4:	4b55                	li	s6,21
    5cb6:	a839                	j	5cd4 <vprintf+0x4c>
        putc(fd, c);
    5cb8:	85ca                	mv	a1,s2
    5cba:	8556                	mv	a0,s5
    5cbc:	00000097          	auipc	ra,0x0
    5cc0:	f10080e7          	jalr	-240(ra) # 5bcc <putc>
    5cc4:	a019                	j	5cca <vprintf+0x42>
    } else if(state == '%'){
    5cc6:	01498d63          	beq	s3,s4,5ce0 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    5cca:	0485                	addi	s1,s1,1
    5ccc:	fff4c903          	lbu	s2,-1(s1)
    5cd0:	16090763          	beqz	s2,5e3e <vprintf+0x1b6>
    if(state == 0){
    5cd4:	fe0999e3          	bnez	s3,5cc6 <vprintf+0x3e>
      if(c == '%'){
    5cd8:	ff4910e3          	bne	s2,s4,5cb8 <vprintf+0x30>
        state = '%';
    5cdc:	89d2                	mv	s3,s4
    5cde:	b7f5                	j	5cca <vprintf+0x42>
      if(c == 'd'){
    5ce0:	13490463          	beq	s2,s4,5e08 <vprintf+0x180>
    5ce4:	f9d9079b          	addiw	a5,s2,-99
    5ce8:	0ff7f793          	zext.b	a5,a5
    5cec:	12fb6763          	bltu	s6,a5,5e1a <vprintf+0x192>
    5cf0:	f9d9079b          	addiw	a5,s2,-99
    5cf4:	0ff7f713          	zext.b	a4,a5
    5cf8:	12eb6163          	bltu	s6,a4,5e1a <vprintf+0x192>
    5cfc:	00271793          	slli	a5,a4,0x2
    5d00:	00003717          	auipc	a4,0x3
    5d04:	b1870713          	addi	a4,a4,-1256 # 8818 <malloc+0x28da>
    5d08:	97ba                	add	a5,a5,a4
    5d0a:	439c                	lw	a5,0(a5)
    5d0c:	97ba                	add	a5,a5,a4
    5d0e:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5d10:	008b8913          	addi	s2,s7,8
    5d14:	4685                	li	a3,1
    5d16:	4629                	li	a2,10
    5d18:	000ba583          	lw	a1,0(s7)
    5d1c:	8556                	mv	a0,s5
    5d1e:	00000097          	auipc	ra,0x0
    5d22:	ed0080e7          	jalr	-304(ra) # 5bee <printint>
    5d26:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5d28:	4981                	li	s3,0
    5d2a:	b745                	j	5cca <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5d2c:	008b8913          	addi	s2,s7,8
    5d30:	4681                	li	a3,0
    5d32:	4629                	li	a2,10
    5d34:	000ba583          	lw	a1,0(s7)
    5d38:	8556                	mv	a0,s5
    5d3a:	00000097          	auipc	ra,0x0
    5d3e:	eb4080e7          	jalr	-332(ra) # 5bee <printint>
    5d42:	8bca                	mv	s7,s2
      state = 0;
    5d44:	4981                	li	s3,0
    5d46:	b751                	j	5cca <vprintf+0x42>
        printint(fd, va_arg(ap, int), 16, 0);
    5d48:	008b8913          	addi	s2,s7,8
    5d4c:	4681                	li	a3,0
    5d4e:	4641                	li	a2,16
    5d50:	000ba583          	lw	a1,0(s7)
    5d54:	8556                	mv	a0,s5
    5d56:	00000097          	auipc	ra,0x0
    5d5a:	e98080e7          	jalr	-360(ra) # 5bee <printint>
    5d5e:	8bca                	mv	s7,s2
      state = 0;
    5d60:	4981                	li	s3,0
    5d62:	b7a5                	j	5cca <vprintf+0x42>
    5d64:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5d66:	008b8c13          	addi	s8,s7,8
    5d6a:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5d6e:	03000593          	li	a1,48
    5d72:	8556                	mv	a0,s5
    5d74:	00000097          	auipc	ra,0x0
    5d78:	e58080e7          	jalr	-424(ra) # 5bcc <putc>
  putc(fd, 'x');
    5d7c:	07800593          	li	a1,120
    5d80:	8556                	mv	a0,s5
    5d82:	00000097          	auipc	ra,0x0
    5d86:	e4a080e7          	jalr	-438(ra) # 5bcc <putc>
    5d8a:	4941                	li	s2,16
    ...
    5da4:	e2c080e7          	jalr	-468(ra) # 5bcc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5da8:	0992                	slli	s3,s3,0x4
    5daa:	397d                	addiw	s2,s2,-1
    5dac:	fe0914e3          	bnez	s2,5d94 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5db0:	8be2                	mv	s7,s8
      state = 0;
    5db2:	4981                	li	s3,0
    5db4:	6c02                	ld	s8,0(sp)
    5db6:	bf11                	j	5cca <vprintf+0x42>
        s = va_arg(ap, char*);
    5db8:	008b8993          	addi	s3,s7,8
    5dbc:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5dc0:	02090163          	beqz	s2,5de2 <vprintf+0x15a>
        while(*s != 0){
    5dc4:	00094583          	lbu	a1,0(s2)
    5dc8:	c9a5                	beqz	a1,5e38 <vprintf+0x1b0>
          putc(fd, *s);
    5dca:	8556                	mv	a0,s5
    5dcc:	00000097          	auipc	ra,0x0
    5dd0:	e00080e7          	jalr	-512(ra) # 5bcc <putc>
          s++;
    5dd4:	0905                	addi	s2,s2,1
        while(*s != 0){
    5dd6:	00094583          	lbu	a1,0(s2)
    5dda:	f9e5                	bnez	a1,5dca <vprintf+0x142>
        s = va_arg(ap, char*);
    5ddc:	8bce                	mv	s7,s3
      state = 0;
    5dde:	4981                	li	s3,0
    5de0:	b5ed                	j	5cca <vprintf+0x42>
          s = "(null)";
    5de2:	00002917          	auipc	s2,0x2
    5de6:	61e90913          	addi	s2,s2,1566 # 8400 <malloc+0x24c2>
        while(*s != 0){
    5dea:	02800593          	li	a1,40
    5dee:	bff1                	j	5dca <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5df0:	008b8913          	addi	s2,s7,8
    5df4:	000bc583          	lbu	a1,0(s7)
    5df8:	8556                	mv	a0,s5
    5dfa:	00000097          	auipc	ra,0x0
    5dfe:	dd2080e7          	jalr	-558(ra) # 5bcc <putc>
    5e02:	8bca                	mv	s7,s2
      state = 0;
    5e04:	4981                	li	s3,0
    5e06:	b5d1                	j	5cca <vprintf+0x42>
        putc(fd, c);
    5e08:	02500593          	li	a1,37
    5e0c:	8556                	mv	a0,s5
    5e0e:	00000097          	auipc	ra,0x0
    5e12:	dbe080e7          	jalr	-578(ra) # 5bcc <putc>
      state = 0;
    5e16:	4981                	li	s3,0
    5e18:	bd4d                	j	5cca <vprintf+0x42>
        putc(fd, '%');
    5e1a:	02500593          	li	a1,37
    5e1e:	8556                	mv	a0,s5
    5e20:	00000097          	auipc	ra,0x0
    5e24:	dac080e7          	jalr	-596(ra) # 5bcc <putc>
        putc(fd, c);
    5e28:	85ca                	mv	a1,s2
    5e2a:	8556                	mv	a0,s5
    5e2c:	00000097          	auipc	ra,0x0
    5e30:	da0080e7          	jalr	-608(ra) # 5bcc <putc>
      state = 0;
    5e34:	4981                	li	s3,0
    5e36:	bd51                	j	5cca <vprintf+0x42>
        s = va_arg(ap, char*);
    5e38:	8bce                	mv	s7,s3
      state = 0;
    5e3a:	4981                	li	s3,0
    5e3c:	b579                	j	5cca <vprintf+0x42>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    5e76:	e16080e7          	jalr	-490(ra) # 5c88 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    5eac:	de0080e7          	jalr	-544(ra) # 5c88 <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5ec8:	d8c7b783          	ld	a5,-628(a5) # 9c50 <freep>
    5ecc:	a02d                	j	5ef6 <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5ece:	4618                	lw	a4,8(a2)
    5ed0:	9f2d                	addw	a4,a4,a1
    5ed2:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5ed6:	6398                	ld	a4,0(a5)
    5ed8:	6310                	ld	a2,0(a4)
    5eda:	a83d                	j	5f18 <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5edc:	ff852703          	lw	a4,-8(a0)
    5ee0:	9f31                	addw	a4,a4,a2
    5ee2:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5ee4:	ff053683          	ld	a3,-16(a0)
    5ee8:	a091                	j	5f2c <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5eea:	6398                	ld	a4,0(a5)
    5eec:	00e7e463          	bltu	a5,a4,5ef4 <free+0x3c>
    5ef0:	00e6ea63          	bltu	a3,a4,5f04 <free+0x4c>
{
    5ef4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ef6:	fed7fae3          	bgeu	a5,a3,5eea <free+0x32>
    5efa:	6398                	ld	a4,0(a5)
    5efc:	00e6e463          	bltu	a3,a4,5f04 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f00:	fee7eae3          	bltu	a5,a4,5ef4 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    ...
    5f14:	fae60de3          	beq	a2,a4,5ece <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    5f28:	fae68ae3          	beq	a3,a4,5edc <free+0x24>
    p->s.ptr = bp->s.ptr;
    5f2c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5f2e:	00004717          	auipc	a4,0x4
    5f32:	d2f73123          	sd	a5,-734(a4) # 9c50 <freep>
}
    5f36:	60a2                	ld	ra,8(sp)
    5f38:	6402                	ld	s0,0(sp)
    5f3a:	0141                	addi	sp,sp,16
    5f3c:	8082                	ret
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5f60:	cf453503          	ld	a0,-780(a0) # 9c50 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5f8c:	cc848493          	addi	s1,s1,-824 # 9c50 <freep>
  if(p == (char*)-1)
    5f90:	5afd                	li	s5,-1
    ...
    5fa0:	4d478793          	addi	a5,a5,1236 # 10470 <base>
    5fa4:	00004717          	auipc	a4,0x4
    5fa8:	caf73623          	sd	a5,-852(a4) # 9c50 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5fe2:	bce080e7          	jalr	-1074(ra) # 5bac <sbrk>
  if(p == (char*)-1)
    ...
    601a:	c2a73d23          	sd	a0,-966(a4) # 9c50 <freep>
      return (void*)(p + 1);
